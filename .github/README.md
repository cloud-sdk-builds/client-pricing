...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.116.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.116.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-h8vi2woozZWxwHNTLbqkCHi+lpBRGH41LJLzlAplpir2eDYQBNiN3aem3NsKl+3z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.116.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.116.0/index.min.mjs": "sha384-h8vi2woozZWxwHNTLbqkCHi+lpBRGH41LJLzlAplpir2eDYQBNiN3aem3NsKl+3z"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.116.0`)
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.116.0/LICENSE
```

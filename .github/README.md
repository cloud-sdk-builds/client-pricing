...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.160.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.160.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-br2A1oxAQqUi4uSiT69kUak+EG4FK/pnjTweb/adntGovLhT+R4q5+wSevXJYOax
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.160.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.160.0/index.min.mjs": "sha384-br2A1oxAQqUi4uSiT69kUak+EG4FK/pnjTweb/adntGovLhT+R4q5+wSevXJYOax"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.160.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.47.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.47.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6rVgtVr40zZMTSF9pUj2G0D6SJiToCPS/9cooxfawRSGmH3HUbqvpntdqaeN/tkD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.47.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.47.0/index.min.mjs": "sha384-6rVgtVr40zZMTSF9pUj2G0D6SJiToCPS/9cooxfawRSGmH3HUbqvpntdqaeN/tkD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.47.0/LICENSE
```

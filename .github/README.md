...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.1020.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1020.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OrhJ08QshmZuV18+Sw0jbnZIz9LwER+knTQypDvxMlYG5RB20RSYAFpbWsnQo59r
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1020.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1020.0/index.min.mjs": "sha384-OrhJ08QshmZuV18+Sw0jbnZIz9LwER+knTQypDvxMlYG5RB20RSYAFpbWsnQo59r"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.1020.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.72.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.72.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KaIO6YpdK7lHlkvnOWvmtm8B0lJK6ouQLeeXWFIDZ0SKvpDlPae8OgFrY/5kF7Fn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.72.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.72.0/index.min.mjs": "sha384-KaIO6YpdK7lHlkvnOWvmtm8B0lJK6ouQLeeXWFIDZ0SKvpDlPae8OgFrY/5kF7Fn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.72.0/LICENSE
```

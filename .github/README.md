...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.922.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.922.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oBS0dwIdij7ac2TWLN/4nzWP4VjmDEQy85hRWkCrQhGP8rOu8Uxjgb1kWPyGjX1w
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.922.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.922.0/index.min.mjs": "sha384-oBS0dwIdij7ac2TWLN/4nzWP4VjmDEQy85hRWkCrQhGP8rOu8Uxjgb1kWPyGjX1w"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.922.0/LICENSE
```

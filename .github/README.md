...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.823.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.823.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QLDfawr6Iw6SHMtHElwuaWVe43M5EA1S5UEcjvBqpv49UBCjg81tXs+dNPykLFJ4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.823.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.823.0/index.min.mjs": "sha384-QLDfawr6Iw6SHMtHElwuaWVe43M5EA1S5UEcjvBqpv49UBCjg81tXs+dNPykLFJ4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.823.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.958.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.958.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8NT7r7yncAtOhEK1tnyFy91nfXHTkVTucdit6xN5qWPLMZE7vx1oH3AfNt50lPeG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.958.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.958.0/index.min.mjs": "sha384-8NT7r7yncAtOhEK1tnyFy91nfXHTkVTucdit6xN5qWPLMZE7vx1oH3AfNt50lPeG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.958.0/LICENSE
```

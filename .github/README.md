...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.418.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.418.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PmCu5zDW6ly11Px1KjyJIhTBH3bckXo4k21AVAXsXbi49t2vetXgiDsTfPJw8+hI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.418.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.418.0/index.min.mjs": "sha384-PmCu5zDW6ly11Px1KjyJIhTBH3bckXo4k21AVAXsXbi49t2vetXgiDsTfPJw8+hI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.418.0/LICENSE
```

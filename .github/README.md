...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.25.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.25.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uIf5bA/R/fzIqo4L9YUvsCi4aC0RAWVI9M0QwJsrzxD91aSLFLlIWoQic43233Qy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.25.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.25.0/index.min.mjs": "sha384-uIf5bA/R/fzIqo4L9YUvsCi4aC0RAWVI9M0QwJsrzxD91aSLFLlIWoQic43233Qy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.25.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.803.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.803.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+ZJWb/q1PPkX3pXye7KcZnrX6rqF2fvJJqC+LoDad4nxP3/SOwmrwI2qTg28iYGb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.803.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.803.0/index.min.mjs": "sha384-+ZJWb/q1PPkX3pXye7KcZnrX6rqF2fvJJqC+LoDad4nxP3/SOwmrwI2qTg28iYGb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.803.0/LICENSE
```

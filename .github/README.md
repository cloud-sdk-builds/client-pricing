...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.658.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.658.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-+p4FZsO+q7TygNaFuqIm6pBkZuW1cumVowNngbKXxoYsFCl4TQYfKWzT5AAoXf1v
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.658.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.658.1/index.min.mjs": "sha384-+p4FZsO+q7TygNaFuqIm6pBkZuW1cumVowNngbKXxoYsFCl4TQYfKWzT5AAoXf1v"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.658.1/LICENSE
```

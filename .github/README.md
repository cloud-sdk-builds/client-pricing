...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.54.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.54.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eUQkfgph3TqPXLcPnz4YylVkaoVNCxVKwPKbu4lBJlLq3Fe9CyMpI3LkrB4sPnJQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.54.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.54.0/index.min.mjs": "sha384-eUQkfgph3TqPXLcPnz4YylVkaoVNCxVKwPKbu4lBJlLq3Fe9CyMpI3LkrB4sPnJQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.54.0/LICENSE
```

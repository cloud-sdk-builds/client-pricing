...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.876.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.876.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3zM/QPVaZtvOyAxjcUkJGuuDwHu6LhjEVYGBhhs745mTOvmp1ANozGY+8PC2jnOt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.876.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.876.0/index.min.mjs": "sha384-3zM/QPVaZtvOyAxjcUkJGuuDwHu6LhjEVYGBhhs745mTOvmp1ANozGY+8PC2jnOt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.876.0/LICENSE
```

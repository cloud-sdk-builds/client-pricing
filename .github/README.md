...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.39.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.39.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qjm3DGXp+Une5P3oMtY+Cv3hFxCaS+44wwbf3mM0a2AjSE+3N4Lf5edS2DfCspYO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.39.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.39.0/index.min.mjs": "sha384-qjm3DGXp+Une5P3oMtY+Cv3hFxCaS+44wwbf3mM0a2AjSE+3N4Lf5edS2DfCspYO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.39.0/LICENSE
```

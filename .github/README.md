...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.287.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.287.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Mh9ecxPbz+TRJ8s+1B6YWN0BmIT7yrOTdD9pFp5zBVXESg1ryfpYtTRWJa04X4Zp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.287.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.287.0/index.min.mjs": "sha384-Mh9ecxPbz+TRJ8s+1B6YWN0BmIT7yrOTdD9pFp5zBVXESg1ryfpYtTRWJa04X4Zp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.287.0/LICENSE
```

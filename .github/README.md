...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.590.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.590.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NsJJ3U0Ho1AUfudqIWOGX/bGuAHk9Ru658Ocdncnyc19T6Cdf4VfP1Sx1DzyDKXm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.590.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.590.0/index.min.mjs": "sha384-NsJJ3U0Ho1AUfudqIWOGX/bGuAHk9Ru658Ocdncnyc19T6Cdf4VfP1Sx1DzyDKXm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.590.0/LICENSE
```

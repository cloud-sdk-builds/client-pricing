...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.264.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.264.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FZdkKy046dFNQuOqINQB+U1/viwiJzXt1ToCEdWZhe4vOhTJ1xHVbgokVkntWG5Q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.264.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.264.0/index.min.mjs": "sha384-FZdkKy046dFNQuOqINQB+U1/viwiJzXt1ToCEdWZhe4vOhTJ1xHVbgokVkntWG5Q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.264.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.816.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.816.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZkurLv9wCF/wb4QtYY0tTjRg+Y5xL8SAp1g7UkRRHz8q0cbHaszKQ9DTMtuvnhRs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.816.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.816.0/index.min.mjs": "sha384-ZkurLv9wCF/wb4QtYY0tTjRg+Y5xL8SAp1g7UkRRHz8q0cbHaszKQ9DTMtuvnhRs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.816.0/LICENSE
```

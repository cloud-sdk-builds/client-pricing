...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.726.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.726.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-Qv8Sz2uHK9VNkJIwCjK8yRbkmvIySsPNpA0WpqcGtXup6MGgF+unUkSf3g8db+II
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.726.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.726.1/index.min.mjs": "sha384-Qv8Sz2uHK9VNkJIwCjK8yRbkmvIySsPNpA0WpqcGtXup6MGgF+unUkSf3g8db+II"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.726.1/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.193.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.193.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rfEW/8Ln7TgzKbVuUWif9EQvOhpDybmLkaSDxBjcP/j9dSU6M43E18A1KrCOMRU2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.193.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.193.0/index.min.mjs": "sha384-rfEW/8Ln7TgzKbVuUWif9EQvOhpDybmLkaSDxBjcP/j9dSU6M43E18A1KrCOMRU2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.193.0/LICENSE
```

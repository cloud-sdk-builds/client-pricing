...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.319.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.319.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xMiE7DSNamEEIFcR2LfOgS7IiOlRT60aPB2eGe27J+LzF31yEsmkVvItlDd3Otm1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.319.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.319.0/index.min.mjs": "sha384-xMiE7DSNamEEIFcR2LfOgS7IiOlRT60aPB2eGe27J+LzF31yEsmkVvItlDd3Otm1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.319.0/LICENSE
```

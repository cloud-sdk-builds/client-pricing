...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.282.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.282.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Om7k/pYDS4XGmbJU6fArYiIKaWefuibJxDX3Qpy/e9EWvCmVDYtFANTyHyh/EfWy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.282.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.282.0/index.min.mjs": "sha384-Om7k/pYDS4XGmbJU6fArYiIKaWefuibJxDX3Qpy/e9EWvCmVDYtFANTyHyh/EfWy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.282.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.749.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.749.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yd9FxulANuGPLJWv6JNfkSvEQSQRCp/Tfy0SX2uevz1deeby6HU97UUi5V7SR6Wn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.749.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.749.0/index.min.mjs": "sha384-yd9FxulANuGPLJWv6JNfkSvEQSQRCp/Tfy0SX2uevz1deeby6HU97UUi5V7SR6Wn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.749.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.844.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.844.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SlpCC0inHTee1/xQ934KCrkyWSEsgk3HaaaWcMaKYwNQyyJBBf1+qfR3dTIMuwqZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.844.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.844.0/index.min.mjs": "sha384-SlpCC0inHTee1/xQ934KCrkyWSEsgk3HaaaWcMaKYwNQyyJBBf1+qfR3dTIMuwqZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.844.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.370.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.370.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RY5ddOq85onWXMqhnS1tqEQubLKv9dKNDDZifCc8xz9PdgV7cl7j2BTQbpmIdy+T
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.370.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.370.0/index.min.mjs": "sha384-RY5ddOq85onWXMqhnS1tqEQubLKv9dKNDDZifCc8xz9PdgV7cl7j2BTQbpmIdy+T"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.370.0/LICENSE
```

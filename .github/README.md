...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.379.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.379.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-mYA7Iz2A3FYMeHn+Y9m/17mUp3d6xMMiyCPGtanaugjN/hdA+z1f7BR1CC1kCh1L
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.379.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.379.1/index.min.mjs": "sha384-mYA7Iz2A3FYMeHn+Y9m/17mUp3d6xMMiyCPGtanaugjN/hdA+z1f7BR1CC1kCh1L"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.379.1/LICENSE
```

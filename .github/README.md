...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.1012.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1012.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HV8XkS1BbDybY7SNjxjGhDOogGLQvupjbTknpSs013gxrhlUvLHgLlHB1PayA4sK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1012.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1012.0/index.min.mjs": "sha384-HV8XkS1BbDybY7SNjxjGhDOogGLQvupjbTknpSs013gxrhlUvLHgLlHB1PayA4sK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.1012.0/LICENSE
```

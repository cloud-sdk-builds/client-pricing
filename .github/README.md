...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.87.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.87.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6OYGKLM5fwHlzqB/CGisSG6uGm9xMG0SQstrnRzfEm3GKMFtBfnWWEkVJRcSIiW1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.87.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.87.0/index.min.mjs": "sha384-6OYGKLM5fwHlzqB/CGisSG6uGm9xMG0SQstrnRzfEm3GKMFtBfnWWEkVJRcSIiW1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.87.0/LICENSE
```

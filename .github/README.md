...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.927.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.927.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-M10fphkMXL0rwjAy8x7Pb4X+oz02wVypP0HYjB5EsOZ5s8CjnoYIfhMAduqandaF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.927.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.927.0/index.min.mjs": "sha384-M10fphkMXL0rwjAy8x7Pb4X+oz02wVypP0HYjB5EsOZ5s8CjnoYIfhMAduqandaF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.927.0/LICENSE
```

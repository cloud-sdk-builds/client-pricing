...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.1029.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1029.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dO5rfLiu8XV+5k9A0kqS36rSfr7eYMcwMhDn2i9+DuHTfAu+PU/QssBtSWP4xTa+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1029.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1029.0/index.min.mjs": "sha384-dO5rfLiu8XV+5k9A0kqS36rSfr7eYMcwMhDn2i9+DuHTfAu+PU/QssBtSWP4xTa+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.1029.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.799.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.799.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-exBfEdIOeRh4X2hgUCRn6y5ot1sxLMbQRyzElCWIuKAZYnJ4jefvYoYrJBu2V+0c
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.799.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.799.0/index.min.mjs": "sha384-exBfEdIOeRh4X2hgUCRn6y5ot1sxLMbQRyzElCWIuKAZYnJ4jefvYoYrJBu2V+0c"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.799.0/LICENSE
```

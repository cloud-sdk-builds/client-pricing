...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.36.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.36.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-wcO7t88pQ+Rub13ex81tnE2hI3lZMivOUBmpz0jaDm0JSJgDq/rGs6TGMlxFp6Xd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.36.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.36.1/index.min.mjs": "sha384-wcO7t88pQ+Rub13ex81tnE2hI3lZMivOUBmpz0jaDm0JSJgDq/rGs6TGMlxFp6Xd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.36.1/LICENSE
```

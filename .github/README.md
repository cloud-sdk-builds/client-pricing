...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.691.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.691.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VmtaN++8oLudmqYrvvZMlyeFHnmzKkZbFq+u15qRDoydmIRIt0OVMKneim6ngPX/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.691.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.691.0/index.min.mjs": "sha384-VmtaN++8oLudmqYrvvZMlyeFHnmzKkZbFq+u15qRDoydmIRIt0OVMKneim6ngPX/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.691.0/LICENSE
```

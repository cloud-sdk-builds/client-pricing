...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.9.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.9.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XIIIeE/6KFCupr2eAGzI1ALAVHJ101h6radrwHfN65PXlBBh3fIv7CP0iJSNWKe3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.9.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.9.0/index.min.mjs": "sha384-XIIIeE/6KFCupr2eAGzI1ALAVHJ101h6radrwHfN65PXlBBh3fIv7CP0iJSNWKe3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.9.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.879.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.879.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cPmae7ZIDzKaGioIP9Nt6fcEzzSxYTCzIFVDQAG/ZNJyDAy3uCxBKe+pl38KQLiW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.879.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.879.0/index.min.mjs": "sha384-cPmae7ZIDzKaGioIP9Nt6fcEzzSxYTCzIFVDQAG/ZNJyDAy3uCxBKe+pl38KQLiW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.879.0/LICENSE
```

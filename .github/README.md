...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.731.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.731.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-2+9zYzM312Oem8QJWcDjK061ocp7X0kYfGxfYLpvquNttIhfODWQs+4yvrbCBiaj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.731.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.731.1/index.min.mjs": "sha384-2+9zYzM312Oem8QJWcDjK061ocp7X0kYfGxfYLpvquNttIhfODWQs+4yvrbCBiaj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.731.1/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.490.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.490.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LJPX6ZZelVsq+0EWzwLbVBnhiSpNCJAVIDO5Kjyj2Zy9cN3+OdhwgKIgjg50g2hi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.490.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.490.0/index.min.mjs": "sha384-LJPX6ZZelVsq+0EWzwLbVBnhiSpNCJAVIDO5Kjyj2Zy9cN3+OdhwgKIgjg50g2hi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.490.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.169.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.169.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gQo7R5Ai/u0rljHsL9Y/ef1hWT4FbXIQtA/9K34E0fNZzPzBM5RwqoQRVuiU8Qe/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.169.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.169.0/index.min.mjs": "sha384-gQo7R5Ai/u0rljHsL9Y/ef1hWT4FbXIQtA/9K34E0fNZzPzBM5RwqoQRVuiU8Qe/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.169.0/LICENSE
```

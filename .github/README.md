...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.353.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.353.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IEJTLtarfF8WDzg4k4RweGgP+2tWS7x9bM8ifw/IOD4lvwUx13K0Rm7LmfZd7HCM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.353.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.353.0/index.min.mjs": "sha384-IEJTLtarfF8WDzg4k4RweGgP+2tWS7x9bM8ifw/IOD4lvwUx13K0Rm7LmfZd7HCM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.353.0/LICENSE
```

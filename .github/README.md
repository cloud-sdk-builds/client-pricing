...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.723.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.723.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-q/Jz7GzLfenMa6GH3iH8SDulC00ZseIcaB9w7QvgYPn6uBLu7C/gTfqKg50pom6/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.723.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.723.0/index.min.mjs": "sha384-q/Jz7GzLfenMa6GH3iH8SDulC00ZseIcaB9w7QvgYPn6uBLu7C/gTfqKg50pom6/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.723.0/LICENSE
```

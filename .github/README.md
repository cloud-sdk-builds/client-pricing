...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.131.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.131.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hWUvkkywy7crbX3kGo0Rb1Rus8F1aSm3GghLZA6OsA1Rb7PCcWZZdwm1t5zmSkpr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.131.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.131.0/index.min.mjs": "sha384-hWUvkkywy7crbX3kGo0Rb1Rus8F1aSm3GghLZA6OsA1Rb7PCcWZZdwm1t5zmSkpr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.131.0/LICENSE
```

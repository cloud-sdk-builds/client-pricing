...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.1034.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1034.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fnuRvoVprO6O3HRb0jNDyEiTGtR02JrdacHCkhupm57nwqP0e5HYKYE0YLWIqBxl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1034.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1034.0/index.min.mjs": "sha384-fnuRvoVprO6O3HRb0jNDyEiTGtR02JrdacHCkhupm57nwqP0e5HYKYE0YLWIqBxl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.1034.0/LICENSE
```

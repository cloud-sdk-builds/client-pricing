...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.624.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.624.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HSamX5nyhlI5D7DQQB92ITwN+i66aXyTHmILYIQJ0zVxJtf7ncJHpo8sBjku9VL3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.624.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.624.0/index.min.mjs": "sha384-HSamX5nyhlI5D7DQQB92ITwN+i66aXyTHmILYIQJ0zVxJtf7ncJHpo8sBjku9VL3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.624.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.81.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.81.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gnpIm3AGpp7OTBtnUoW/Jpjv3Ra5d+MwuvkX1FS6LUCEdkW6ww+q5BdPrrWFV3A1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.81.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.81.0/index.min.mjs": "sha384-gnpIm3AGpp7OTBtnUoW/Jpjv3Ra5d+MwuvkX1FS6LUCEdkW6ww+q5BdPrrWFV3A1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.81.0/LICENSE
```

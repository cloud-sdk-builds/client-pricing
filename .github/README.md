...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.965.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.965.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hbPoID/QQ59R1Ddk+szFG6UAr56aHKsh56cVZi/re0D7zrJxUh6PqiOEZUZTTkhU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.965.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.965.0/index.min.mjs": "sha384-hbPoID/QQ59R1Ddk+szFG6UAr56aHKsh56cVZi/re0D7zrJxUh6PqiOEZUZTTkhU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.965.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.507.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.507.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tmkKGsxJ0MhEpMoFJz3EIqO7NgRK2hN3kZJt+odT7W7N+baN5GbIIZoPk/28QXel
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.507.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.507.0/index.min.mjs": "sha384-tmkKGsxJ0MhEpMoFJz3EIqO7NgRK2hN3kZJt+odT7W7N+baN5GbIIZoPk/28QXel"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.507.0/LICENSE
```

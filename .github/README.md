...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.357.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.357.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xR6E99LdeVvH5WTqb0VtF5RUYWfjhvNy75evHveH+Mg3AcfyQt5gjr7IMAMn7Oqr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.357.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.357.0/index.min.mjs": "sha384-xR6E99LdeVvH5WTqb0VtF5RUYWfjhvNy75evHveH+Mg3AcfyQt5gjr7IMAMn7Oqr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.357.0/LICENSE
```

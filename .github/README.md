...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.983.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.983.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-N4Ac4KOKtpVTZv90QjLKx89IG2rb/JfgLjpXsL8eMvWbXm6EG82pIdL3bQTPZdFv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.983.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.983.0/index.min.mjs": "sha384-N4Ac4KOKtpVTZv90QjLKx89IG2rb/JfgLjpXsL8eMvWbXm6EG82pIdL3bQTPZdFv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.983.0/LICENSE
```

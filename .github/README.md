...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.864.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.864.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kxnqtB6+D49KQO5cD0zq3IGllO/EAKOrpWhKiIQU0yD8Yjv0XqcXeOJrJgVH1TmQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.864.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.864.0/index.min.mjs": "sha384-kxnqtB6+D49KQO5cD0zq3IGllO/EAKOrpWhKiIQU0yD8Yjv0XqcXeOJrJgVH1TmQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.864.0/LICENSE
```

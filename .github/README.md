...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.894.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.894.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7a3/wzTq4lE+ejWgCHnqaalCnVoAfsHZBVz/gnJwYFYaRt3JNjO0VK6INltmi22u
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.894.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.894.0/index.min.mjs": "sha384-7a3/wzTq4lE+ejWgCHnqaalCnVoAfsHZBVz/gnJwYFYaRt3JNjO0VK6INltmi22u"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.894.0/LICENSE
```

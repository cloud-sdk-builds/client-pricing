...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.337.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.337.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sgINaGq7XbVe4NvXv+fvGDkzyeYwtOKy6ODG+xGsZuwy3edyiVx4Q9RMDuzK8vSj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.337.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.337.0/index.min.mjs": "sha384-sgINaGq7XbVe4NvXv+fvGDkzyeYwtOKy6ODG+xGsZuwy3edyiVx4Q9RMDuzK8vSj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.337.0/LICENSE
```

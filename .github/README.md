...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.271.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.271.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-y+eB0WaKycBu3e3PQKNEN9DwddSiewI5TcGDRBSTwnu5q/oMMASCcAkLn6ZUltrR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.271.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.271.0/index.min.mjs": "sha384-y+eB0WaKycBu3e3PQKNEN9DwddSiewI5TcGDRBSTwnu5q/oMMASCcAkLn6ZUltrR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.271.0/LICENSE
```

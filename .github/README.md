...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.332.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.332.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MQ7rgdCwCYuZUAKjGEZwBnXFb2y/EeFFyzwcFT+DCwC3utcVLbXb7M5t+s+eriS0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.332.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.332.0/index.min.mjs": "sha384-MQ7rgdCwCYuZUAKjGEZwBnXFb2y/EeFFyzwcFT+DCwC3utcVLbXb7M5t+s+eriS0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.332.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.278.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.278.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2p4fB+0FQLw41UdFikQb0XF50xw1VEvq5cq1pcFv+xv6CuI0K5/ljGOuaL3Cxbkb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.278.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.278.0/index.min.mjs": "sha384-2p4fB+0FQLw41UdFikQb0XF50xw1VEvq5cq1pcFv+xv6CuI0K5/ljGOuaL3Cxbkb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.278.0/LICENSE
```

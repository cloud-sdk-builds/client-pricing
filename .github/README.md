...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.631.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.631.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-abY4AeXe5LQMBPIDMWRaB8s0IxISEqbMicoRUykTfoDP6JJ37nSr0eu7ukvqVpvL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.631.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.631.0/index.min.mjs": "sha384-abY4AeXe5LQMBPIDMWRaB8s0IxISEqbMicoRUykTfoDP6JJ37nSr0eu7ukvqVpvL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.631.0/LICENSE
```

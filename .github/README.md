...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.267.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.267.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vdXLZvroHoRh/Oxi17NewEdFqbPTzIlM+gyy2cWlDfC0RraPwfig3wjgvTQ/QK9P
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.267.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.267.0/index.min.mjs": "sha384-vdXLZvroHoRh/Oxi17NewEdFqbPTzIlM+gyy2cWlDfC0RraPwfig3wjgvTQ/QK9P"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.267.0/LICENSE
```

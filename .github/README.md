...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.360.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.360.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qffX+Cp3CLzJkRrTAVFZAX0g3zxBrIS9+cWfbnE9E+lOsCxfz33HLbESXANCgu6O
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.360.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.360.0/index.min.mjs": "sha384-qffX+Cp3CLzJkRrTAVFZAX0g3zxBrIS9+cWfbnE9E+lOsCxfz33HLbESXANCgu6O"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.360.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.632.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.632.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KfZySAb5KM4cRVYhB6uiJm50G+O73mqK6p/CEcOj/YZJ9nl91DHN8kxPmzbmrcGf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.632.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.632.0/index.min.mjs": "sha384-KfZySAb5KM4cRVYhB6uiJm50G+O73mqK6p/CEcOj/YZJ9nl91DHN8kxPmzbmrcGf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.632.0/LICENSE
```

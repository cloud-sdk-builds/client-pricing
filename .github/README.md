...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.342.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.342.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8Ql+47be+pWiLjlSU1E5G5cdtQwU9IIKBrorr0m0nZ+ABVlzNWdUzkhjTKdLwSTR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.342.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.342.0/index.min.mjs": "sha384-8Ql+47be+pWiLjlSU1E5G5cdtQwU9IIKBrorr0m0nZ+ABVlzNWdUzkhjTKdLwSTR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.342.0/LICENSE
```

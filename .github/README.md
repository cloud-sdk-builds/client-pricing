...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.252.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.252.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qr58FXUPYo2Ks09PVjkMpxQntcnPCNkXY4uD9hKwKWfCIZ7SS7G6R+N8WWCU+Vi6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.252.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.252.0/index.min.mjs": "sha384-qr58FXUPYo2Ks09PVjkMpxQntcnPCNkXY4uD9hKwKWfCIZ7SS7G6R+N8WWCU+Vi6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.252.0/LICENSE
```

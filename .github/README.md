...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.430.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.430.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-So65QG9Mr7nNNaNc+6klsJRLx3TcFshJOBP1TpWE1uwp0RIWz8RFTW9HeVrhFn38
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.430.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.430.0/index.min.mjs": "sha384-So65QG9Mr7nNNaNc+6klsJRLx3TcFshJOBP1TpWE1uwp0RIWz8RFTW9HeVrhFn38"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.430.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.190.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.190.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1SCsBENSeFJOs5zNJiOxvHfxj2zObGtnvVn9tQD+lDFcYWXOCn5fI57V57zz9+E6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.190.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.190.0/index.min.mjs": "sha384-1SCsBENSeFJOs5zNJiOxvHfxj2zObGtnvVn9tQD+lDFcYWXOCn5fI57V57zz9+E6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.190.0/LICENSE
```

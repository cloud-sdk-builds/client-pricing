...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.358.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.358.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KpnSkcrOqE+Ul0tmKP87h88YGNo/+Nnr5i1t6IGI1xMU6cFnBQ0olywbzBokFj6J
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.358.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.358.0/index.min.mjs": "sha384-KpnSkcrOqE+Ul0tmKP87h88YGNo/+Nnr5i1t6IGI1xMU6cFnBQ0olywbzBokFj6J"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.358.0/LICENSE
```

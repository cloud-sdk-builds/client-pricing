...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.460.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.460.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BTPFweaw6gs4lQZqu+webpDwf3dKu1kFOZeKukpS7HMcuvn6W7zTT6qrxfTBxIc3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.460.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.460.0/index.min.mjs": "sha384-BTPFweaw6gs4lQZqu+webpDwf3dKu1kFOZeKukpS7HMcuvn6W7zTT6qrxfTBxIc3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.460.0/LICENSE
```

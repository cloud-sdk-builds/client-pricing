...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.79.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.79.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8E/p+NSHUX+nIej4p+k1VwvToIwne4Z1q3zUCXSOXGUFjPDqoySNZa5UhL+furvg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.79.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.79.0/index.min.mjs": "sha384-8E/p+NSHUX+nIej4p+k1VwvToIwne4Z1q3zUCXSOXGUFjPDqoySNZa5UhL+furvg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.79.0/LICENSE
```

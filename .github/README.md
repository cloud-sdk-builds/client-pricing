...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.988.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.988.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/KWoRjbfzbs67T5573mL/KjSv5munxrbxa7eTE/qFunVag+uJOYuGpoLBlPxiqtO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.988.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.988.0/index.min.mjs": "sha384-/KWoRjbfzbs67T5573mL/KjSv5munxrbxa7eTE/qFunVag+uJOYuGpoLBlPxiqtO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.988.0/LICENSE
```

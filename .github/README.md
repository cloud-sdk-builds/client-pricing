...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.521.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.521.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-10cfYDddXWZ1B4VNqnMR4BhgXpBfyaEsZH0JEXfRRAq+4CXKLVZQRZWVTHhC6dy4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.521.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.521.0/index.min.mjs": "sha384-10cfYDddXWZ1B4VNqnMR4BhgXpBfyaEsZH0JEXfRRAq+4CXKLVZQRZWVTHhC6dy4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.521.0/LICENSE
```

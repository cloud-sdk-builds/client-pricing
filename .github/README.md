...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.369.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.369.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-c5npzf6aVtYtn9s3V3Sw8j3tTGmDar52JPi6FyQU6Qp+EhIN1VPNVTxN8HOGdktG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.369.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.369.0/index.min.mjs": "sha384-c5npzf6aVtYtn9s3V3Sw8j3tTGmDar52JPi6FyQU6Qp+EhIN1VPNVTxN8HOGdktG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.369.0/LICENSE
```

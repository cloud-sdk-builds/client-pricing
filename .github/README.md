...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.969.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.969.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eALss/JUE6/8OYjNA0vbFPfLJw6sm5XvSmf9TzlJwG5qltgB48HaYwZvluMw0Men
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.969.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.969.0/index.min.mjs": "sha384-eALss/JUE6/8OYjNA0vbFPfLJw6sm5XvSmf9TzlJwG5qltgB48HaYwZvluMw0Men"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.969.0/LICENSE
```

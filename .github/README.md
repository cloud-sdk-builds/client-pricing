...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.743.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.743.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MSaO1qYb27oOWXqrt0x7sbvUN3xDuUvaEvzYu9n03Y+46+1P84FmLySzQxI/ONqj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.743.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.743.0/index.min.mjs": "sha384-MSaO1qYb27oOWXqrt0x7sbvUN3xDuUvaEvzYu9n03Y+46+1P84FmLySzQxI/ONqj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.743.0/LICENSE
```

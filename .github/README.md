...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.934.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.934.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7SxceTkNwoXgiSbcfjSs8Wr+TpHnElSQb1QXi4VwMuoo88cS5euakutkSJrkmP79
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.934.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.934.0/index.min.mjs": "sha384-7SxceTkNwoXgiSbcfjSs8Wr+TpHnElSQb1QXi4VwMuoo88cS5euakutkSJrkmP79"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.934.0/LICENSE
```

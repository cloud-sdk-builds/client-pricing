...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.887.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.887.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JrHO2ImYpiooSIF5xQge4ESjQVPssd8hFM+GpIZGOp2opuCbEkT9XH+1DO2d/n7M
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.887.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.887.0/index.min.mjs": "sha384-JrHO2ImYpiooSIF5xQge4ESjQVPssd8hFM+GpIZGOp2opuCbEkT9XH+1DO2d/n7M"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.887.0/LICENSE
```

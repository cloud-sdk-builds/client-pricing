...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.914.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.914.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Z2nCTQLsfNRyrwzLQLVIVss1YlvZXbbZhFZ9hnBVgSrwgYm85kk4gDrk9wNaXwwT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.914.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.914.0/index.min.mjs": "sha384-Z2nCTQLsfNRyrwzLQLVIVss1YlvZXbbZhFZ9hnBVgSrwgYm85kk4gDrk9wNaXwwT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.914.0/LICENSE
```

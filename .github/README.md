...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.664.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.664.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SWFF36oo8sixXvV8EtbCb86enla4/ZRvm/86VaRI2e/nt6qrTq+jalyW0/WzPe+z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.664.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.664.0/index.min.mjs": "sha384-SWFF36oo8sixXvV8EtbCb86enla4/ZRvm/86VaRI2e/nt6qrTq+jalyW0/WzPe+z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.664.0/LICENSE
```

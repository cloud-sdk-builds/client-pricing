...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.47.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.47.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-l7v4xrMm5h8Bvy/pUVftaXymM33uai5utqBeK9+afLRvzSvswJcIGe27CPxtsKwl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.47.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.47.1/index.min.mjs": "sha384-l7v4xrMm5h8Bvy/pUVftaXymM33uai5utqBeK9+afLRvzSvswJcIGe27CPxtsKwl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.47.1/LICENSE
```

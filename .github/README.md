...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.954.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.954.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PWOk12nj6/P6BVMDyXl4XTiu8Kr748qlXYNCvVtPIK+kPYY+3GAqPEN0T1AN4MJv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.954.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.954.0/index.min.mjs": "sha384-PWOk12nj6/P6BVMDyXl4XTiu8Kr748qlXYNCvVtPIK+kPYY+3GAqPEN0T1AN4MJv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.954.0/LICENSE
```

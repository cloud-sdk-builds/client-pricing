...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.201.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.201.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hRV9s3ZEy2eria3b3ILF8ID05hVdqcCgKdFi60ovKhAddeKNRGTTWxpsz6N16q2Q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.201.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.201.0/index.min.mjs": "sha384-hRV9s3ZEy2eria3b3ILF8ID05hVdqcCgKdFi60ovKhAddeKNRGTTWxpsz6N16q2Q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.201.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.677.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.677.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-e+jstvpfNgtzQ14Wd5EFAopXoEfxO20CVizk9+4FjHAM9kxBKc4Xihz+ravvy42k
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.677.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.677.0/index.min.mjs": "sha384-e+jstvpfNgtzQ14Wd5EFAopXoEfxO20CVizk9+4FjHAM9kxBKc4Xihz+ravvy42k"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.677.0/LICENSE
```

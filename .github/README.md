...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.427.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.427.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DCOmhw70cZ9I3ueYWJY/6GCiP7CLXt+PYQBepxKP7ZxNfR1BnL/RMO1fCiHM7sQY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.427.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.427.0/index.min.mjs": "sha384-DCOmhw70cZ9I3ueYWJY/6GCiP7CLXt+PYQBepxKP7ZxNfR1BnL/RMO1fCiHM7sQY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.427.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.981.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.981.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oS2m6td8rTauy7bgl7SD7mQ1EPl4bsF8DtdRmWwuJDioYnpzVYfoAO9oCnhQHWKL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.981.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.981.0/index.min.mjs": "sha384-oS2m6td8rTauy7bgl7SD7mQ1EPl4bsF8DtdRmWwuJDioYnpzVYfoAO9oCnhQHWKL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.981.0/LICENSE
```

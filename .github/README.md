...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.347.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.347.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-m81q89solTkM16+WFMKaF4XCHSroHzqPP4F2+N+SGERmGy5jFJjVWxhvv4GxWrRe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.347.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.347.1/index.min.mjs": "sha384-m81q89solTkM16+WFMKaF4XCHSroHzqPP4F2+N+SGERmGy5jFJjVWxhvv4GxWrRe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.347.1/LICENSE
```

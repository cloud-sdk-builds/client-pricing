...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.650.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.650.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Mz3RJjKSqn5g/xPeiWmQ0sYW7kMTRzPDXPzaVR+hh7ocv/5Tz0+YGTLgmJDISImr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.650.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.650.0/index.min.mjs": "sha384-Mz3RJjKSqn5g/xPeiWmQ0sYW7kMTRzPDXPzaVR+hh7ocv/5Tz0+YGTLgmJDISImr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.650.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.996.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.996.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-H85y2gxmd/fPlgTUlaBpB0KbmGP74ztw8Ed3pMEJWHf1Ik7qDj7X8AiNfUrcy9jy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.996.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.996.0/index.min.mjs": "sha384-H85y2gxmd/fPlgTUlaBpB0KbmGP74ztw8Ed3pMEJWHf1Ik7qDj7X8AiNfUrcy9jy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.996.0/LICENSE
```

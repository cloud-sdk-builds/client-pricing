...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.750.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.750.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-k4lxDTCeFmUkcMectjOEmw6wzTGKi9YtcqYA1gHAZH0HleICYOaFnqV22X4K4l4r
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.750.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.750.0/index.min.mjs": "sha384-k4lxDTCeFmUkcMectjOEmw6wzTGKi9YtcqYA1gHAZH0HleICYOaFnqV22X4K4l4r"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.750.0/LICENSE
```

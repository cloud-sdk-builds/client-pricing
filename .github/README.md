...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.37.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.37.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YlB3jB6Wn8C5auTV3AP+fzgwv8BQZ6LoJoxHzv699FoQH+Je9Hf3GeJacWEilEMY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.37.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.37.0/index.min.mjs": "sha384-YlB3jB6Wn8C5auTV3AP+fzgwv8BQZ6LoJoxHzv699FoQH+Je9Hf3GeJacWEilEMY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.37.0/LICENSE
```

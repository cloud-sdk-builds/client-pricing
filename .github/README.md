...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.668.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.668.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CNOeXIAl4N+lbBn4EBiDihu2EfnqeGuj+tWuxaG5JykiUCLl0m/PVP7/FVr6k3su
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.668.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.668.0/index.min.mjs": "sha384-CNOeXIAl4N+lbBn4EBiDihu2EfnqeGuj+tWuxaG5JykiUCLl0m/PVP7/FVr6k3su"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.668.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.582.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.582.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-P+luoZOXY1wOcDUr5h2Y79u41S5sU3QU84uU/FElDbqnfq6t7LTcPwM6XKAz08G+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.582.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.582.0/index.min.mjs": "sha384-P+luoZOXY1wOcDUr5h2Y79u41S5sU3QU84uU/FElDbqnfq6t7LTcPwM6XKAz08G+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.582.0/LICENSE
```

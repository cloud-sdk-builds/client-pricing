...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.438.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.438.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8FFjoJHbv3RPuwvilCJwhU63pYYMCXHSEJZhFUHjrqiKhYLr/+bgC1rO1a+6Jov1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.438.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.438.0/index.min.mjs": "sha384-8FFjoJHbv3RPuwvilCJwhU63pYYMCXHSEJZhFUHjrqiKhYLr/+bgC1rO1a+6Jov1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.438.0/LICENSE
```

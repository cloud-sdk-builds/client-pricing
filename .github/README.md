...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.503.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.503.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-wGU+uFm9di4vXBuOuyE6PmEGldXLd63NnAh1mBDGqddbhSwFz1Ra0tHCW9R+5Nja
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.503.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.503.1/index.min.mjs": "sha384-wGU+uFm9di4vXBuOuyE6PmEGldXLd63NnAh1mBDGqddbhSwFz1Ra0tHCW9R+5Nja"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.503.1/LICENSE
```

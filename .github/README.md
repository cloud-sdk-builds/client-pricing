...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.354.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.354.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PuuRJ7//pUzhATY6yqqqPcvVJ+SVWR3Zu2QLtXZxfd0lcWjkI/+TRBoCQW2ElmZq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.354.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.354.0/index.min.mjs": "sha384-PuuRJ7//pUzhATY6yqqqPcvVJ+SVWR3Zu2QLtXZxfd0lcWjkI/+TRBoCQW2ElmZq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.354.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.893.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.893.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ODy2MZaVp6/TwGrnRJDFVXKOYC3offnZkoK0ZVfE57gpPB0YKUN76LK6C9ksXgkS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.893.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.893.0/index.min.mjs": "sha384-ODy2MZaVp6/TwGrnRJDFVXKOYC3offnZkoK0ZVfE57gpPB0YKUN76LK6C9ksXgkS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.893.0/LICENSE
```

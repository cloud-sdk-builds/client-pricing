...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.261.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.261.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8HZIeEXSlMh6HnsOVn3fNeKsVfeDdZFfXBwbE2VFxh2ktEn6vZ7NZHje4dxOPfms
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.261.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.261.0/index.min.mjs": "sha384-8HZIeEXSlMh6HnsOVn3fNeKsVfeDdZFfXBwbE2VFxh2ktEn6vZ7NZHje4dxOPfms"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.261.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.335.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.335.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jsF86fjXGLb635Sx6ohFkhOAevtfV7DUKwynsTU84A9Pcwm/ykTKMU7JRapNFEZh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.335.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.335.0/index.min.mjs": "sha384-jsF86fjXGLb635Sx6ohFkhOAevtfV7DUKwynsTU84A9Pcwm/ykTKMU7JRapNFEZh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.335.0/LICENSE
```

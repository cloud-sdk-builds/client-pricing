...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.1025.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1025.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xbPlRnuKEAeohxu1Od+EoeHSNiFPe++gIBRDzzAV9v2PNlITLbUHt6oUVbEiLUW5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1025.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1025.0/index.min.mjs": "sha384-xbPlRnuKEAeohxu1Od+EoeHSNiFPe++gIBRDzzAV9v2PNlITLbUHt6oUVbEiLUW5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.1025.0/LICENSE
```

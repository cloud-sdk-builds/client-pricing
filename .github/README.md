...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.935.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.935.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-v150nIPzaYobZXqvuUlnlYtUapFZzMdpIiwrdxbbwg5uyk1TKhdE605g3WfdL1UN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.935.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.935.0/index.min.mjs": "sha384-v150nIPzaYobZXqvuUlnlYtUapFZzMdpIiwrdxbbwg5uyk1TKhdE605g3WfdL1UN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.935.0/LICENSE
```

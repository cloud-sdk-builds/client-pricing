...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.188.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.188.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ncySfrRc6TXG760CDsxMR0O+0+Mq/696Zz1rOLkmjYiZRDWMM/EkH3Sp/Vs8inez
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.188.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.188.0/index.min.mjs": "sha384-ncySfrRc6TXG760CDsxMR0O+0+Mq/696Zz1rOLkmjYiZRDWMM/EkH3Sp/Vs8inez"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.188.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.523.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.523.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xBWyFKp0vWFoV0VR1nv2BTS2jGRbwCivy+d0N3Kf3RPCdvG+hfuEEOikvokSZQIG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.523.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.523.0/index.min.mjs": "sha384-xBWyFKp0vWFoV0VR1nv2BTS2jGRbwCivy+d0N3Kf3RPCdvG+hfuEEOikvokSZQIG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.523.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.798.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.798.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jsx6twoEMINbPLna1PAFtI7nyzn2bqQhcbv5cJXBLJydjRxD5T4/Q+9rBUTIJxq7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.798.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.798.0/index.min.mjs": "sha384-jsx6twoEMINbPLna1PAFtI7nyzn2bqQhcbv5cJXBLJydjRxD5T4/Q+9rBUTIJxq7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.798.0/LICENSE
```

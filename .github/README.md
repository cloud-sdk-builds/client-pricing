...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.873.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.873.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-s4VEEZQCrgtv/8oYyrdXlQSY+YzpuzHySYFc3DYZ7fiIHHEYGaErBR2WIsG2ZceS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.873.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.873.0/index.min.mjs": "sha384-s4VEEZQCrgtv/8oYyrdXlQSY+YzpuzHySYFc3DYZ7fiIHHEYGaErBR2WIsG2ZceS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.873.0/LICENSE
```

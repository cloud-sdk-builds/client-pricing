...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.82.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.82.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-39zIYe3f3klIBOg8XbzRRZb3AHd0kZKGg/FlTS3rsfwKHK4BtfXqhwZNXDuUVg29
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.82.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.82.0/index.min.mjs": "sha384-39zIYe3f3klIBOg8XbzRRZb3AHd0kZKGg/FlTS3rsfwKHK4BtfXqhwZNXDuUVg29"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.82.0/LICENSE
```

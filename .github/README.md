...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.128.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.128.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cF/T1LOOKUfxQeK5eVGkQGq2H8VR+7IUDAS0GlauVNfJYsoIsAqCYdLJMJdd9fib
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.128.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.128.0/index.min.mjs": "sha384-cF/T1LOOKUfxQeK5eVGkQGq2H8VR+7IUDAS0GlauVNfJYsoIsAqCYdLJMJdd9fib"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.128.0/LICENSE
```

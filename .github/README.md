...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.109.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.109.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-n1AS4N42zcsiCMwMLlYJBezs8XZXRlE3P54iVn5+iS0PfhNiSIrwoDRU9GStYT1l
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.109.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.109.0/index.min.mjs": "sha384-n1AS4N42zcsiCMwMLlYJBezs8XZXRlE3P54iVn5+iS0PfhNiSIrwoDRU9GStYT1l"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.109.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.477.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.477.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-36dYSSidl3nJ8Dy9Yxji4B21Zr8iC+fdoHzGMlIepWwrOaDuufnhHaolIP2tQzYE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.477.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.477.0/index.min.mjs": "sha384-36dYSSidl3nJ8Dy9Yxji4B21Zr8iC+fdoHzGMlIepWwrOaDuufnhHaolIP2tQzYE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.477.0/LICENSE
```

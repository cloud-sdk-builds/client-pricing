...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.95.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.95.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-efc1g6ScyHKCpy5AVPTDr2Ymw/6bM9ZILgbyqUYlolBlmCFhirW8SMzMOsOcWCo8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.95.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.95.0/index.min.mjs": "sha384-efc1g6ScyHKCpy5AVPTDr2Ymw/6bM9ZILgbyqUYlolBlmCFhirW8SMzMOsOcWCo8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.95.0/LICENSE
```

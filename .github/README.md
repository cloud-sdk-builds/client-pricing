...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.213.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.213.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vBo3YWBkK585C2G8dHC6w/aRlNaXqPMkfnSIYOwcv6n4AO8hUQJ+vrKkanCrkQtk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.213.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.213.0/index.min.mjs": "sha384-vBo3YWBkK585C2G8dHC6w/aRlNaXqPMkfnSIYOwcv6n4AO8hUQJ+vrKkanCrkQtk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.213.0/LICENSE
```

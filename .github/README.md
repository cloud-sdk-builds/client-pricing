...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.661.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.661.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-W/Iztmxe0IkzQvBlUiKfVehh9HhPRrgqsfsza419ZJvVlKsQcjLzCt9axJfprO4p
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.661.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.661.0/index.min.mjs": "sha384-W/Iztmxe0IkzQvBlUiKfVehh9HhPRrgqsfsza419ZJvVlKsQcjLzCt9axJfprO4p"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.661.0`)
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.661.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.620.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.620.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-I9ymNDMGZZhIQOl6sQo/Dr4kMZorC2zufjzU88bspwrMcvyHf+6Tn8U0zg4IyyVW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.620.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.620.1/index.min.mjs": "sha384-I9ymNDMGZZhIQOl6sQo/Dr4kMZorC2zufjzU88bspwrMcvyHf+6Tn8U0zg4IyyVW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.620.1/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.577.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.577.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LTr+OoHkTzdm/MB+5+oZXx5r/dUCpkohJlXZV3Ri32RTRumnGpd/Xar1oFMZJSVf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.577.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.577.0/index.min.mjs": "sha384-LTr+OoHkTzdm/MB+5+oZXx5r/dUCpkohJlXZV3Ri32RTRumnGpd/Xar1oFMZJSVf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.577.0/LICENSE
```

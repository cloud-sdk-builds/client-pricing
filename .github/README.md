...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.327.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.327.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1pDrjoRJQTinQUY+runJ38OLSlWcr4/D0n76gXY1+ZnrCt4w/nGZIAJJ8Oge2wQp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.327.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.327.0/index.min.mjs": "sha384-1pDrjoRJQTinQUY+runJ38OLSlWcr4/D0n76gXY1+ZnrCt4w/nGZIAJJ8Oge2wQp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.327.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.100.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.100.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UA2DaWNHak75jdWTHDVBDSobBnIMOc4oqzrWJaFBZ4coD39aydRQ6xpXuhv2r1fL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.100.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.100.0/index.min.mjs": "sha384-UA2DaWNHak75jdWTHDVBDSobBnIMOc4oqzrWJaFBZ4coD39aydRQ6xpXuhv2r1fL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.100.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.13.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.13.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-e37Romg/zTA29FtvmDUt/wDly5eJNq93bMpyPmrIdgxcNEzgt2pYcSTXfxgH0Mg3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.13.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.13.1/index.min.mjs": "sha384-e37Romg/zTA29FtvmDUt/wDly5eJNq93bMpyPmrIdgxcNEzgt2pYcSTXfxgH0Mg3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.13.1/LICENSE
```

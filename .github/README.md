...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.410.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.410.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wy3bJ+nLfZU1RsFfm7mK5Di4x97ISePLOp3gv4eiee4i74xNe9hbQpqDjREuW/j5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.410.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.410.0/index.min.mjs": "sha384-wy3bJ+nLfZU1RsFfm7mK5Di4x97ISePLOp3gv4eiee4i74xNe9hbQpqDjREuW/j5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.410.0/LICENSE
```

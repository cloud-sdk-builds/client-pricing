...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.42.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.42.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PhPeHzD8TXpsZPvndEsIrguClHNYzhz5hc2c00X0X4aJEnjvBa49NRclLAi7/PT7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.42.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.42.0/index.min.mjs": "sha384-PhPeHzD8TXpsZPvndEsIrguClHNYzhz5hc2c00X0X4aJEnjvBa49NRclLAi7/PT7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.42.0/LICENSE
```

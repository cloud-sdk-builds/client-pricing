...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.421.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.421.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/xacsT8HU4bhMHCS9Wcx4vlZv3BVueS+WzpIvEGGjX5aAqyVb0cF5PxQs75vqlt6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.421.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.421.0/index.min.mjs": "sha384-/xacsT8HU4bhMHCS9Wcx4vlZv3BVueS+WzpIvEGGjX5aAqyVb0cF5PxQs75vqlt6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.421.0/LICENSE
```

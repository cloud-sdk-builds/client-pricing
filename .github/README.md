...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.972.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.972.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NxeNlSFcDYiPis4/aC5TyuvpSHs+XTuu8KUblRUiz6ILYB4fmU1vwsCf5YhC4AsX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.972.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.972.0/index.min.mjs": "sha384-NxeNlSFcDYiPis4/aC5TyuvpSHs+XTuu8KUblRUiz6ILYB4fmU1vwsCf5YhC4AsX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.972.0/LICENSE
```

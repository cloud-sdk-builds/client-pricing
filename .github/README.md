...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.835.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.835.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-d0tdfKY4FSz5ooIMZkZ97wC1EYXO5jU11KecvpMSTdDE55ymXHCIrD2V5m3ORFSU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.835.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.835.0/index.min.mjs": "sha384-d0tdfKY4FSz5ooIMZkZ97wC1EYXO5jU11KecvpMSTdDE55ymXHCIrD2V5m3ORFSU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.835.0/LICENSE
```

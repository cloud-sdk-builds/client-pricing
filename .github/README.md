...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.4.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.4.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-NdHMgdZJXjS+Qzv8eTY++ZN3KNrfgT+/A6QnvQ1B1z/CzEweDdq+/lnxJnaYQ31c
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.4.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.4.1/index.min.mjs": "sha384-NdHMgdZJXjS+Qzv8eTY++ZN3KNrfgT+/A6QnvQ1B1z/CzEweDdq+/lnxJnaYQ31c"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.4.1/LICENSE
```

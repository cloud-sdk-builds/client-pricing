...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.511.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.511.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hU4kBcr4HyLcFAD99hjpWbYlbj7PJCY7tPPl05NhnGEbSb/+8sw9bZpW4tT2rz53
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.511.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.511.0/index.min.mjs": "sha384-hU4kBcr4HyLcFAD99hjpWbYlbj7PJCY7tPPl05NhnGEbSb/+8sw9bZpW4tT2rz53"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.511.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.592.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.592.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IavaH4RN46E0M/IdxcQXnTqgWF1bK7JUT9RGt+x4Ny4V7t+Bm+bUuiZbk13gYGMX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.592.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.592.0/index.min.mjs": "sha384-IavaH4RN46E0M/IdxcQXnTqgWF1bK7JUT9RGt+x4Ny4V7t+Bm+bUuiZbk13gYGMX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.592.0/LICENSE
```

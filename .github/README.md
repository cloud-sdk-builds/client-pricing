...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.567.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.567.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KHs64w6zSYwGP5FsM8uXA4wuxM0sE6RX9VFT8xptGSPjtONJpC01NSqDm+Kip7L6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.567.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.567.0/index.min.mjs": "sha384-KHs64w6zSYwGP5FsM8uXA4wuxM0sE6RX9VFT8xptGSPjtONJpC01NSqDm+Kip7L6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.567.0/LICENSE
```

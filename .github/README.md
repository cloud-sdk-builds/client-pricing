...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.74.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.74.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p0V851Am6GEE+jpCrToPF5THULR1YWR+5e6w5BVWeGJ8DYVl9sERsaP5tgH2luns
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.74.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.74.0/index.min.mjs": "sha384-p0V851Am6GEE+jpCrToPF5THULR1YWR+5e6w5BVWeGJ8DYVl9sERsaP5tgH2luns"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.74.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.50.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.50.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-i4WvSN2jMgQdegnH/ambh8eIPHAyN4AQ8Vx9WJ1KVUQ20FbHZW65XDBOUC52sZFZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.50.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.50.0/index.min.mjs": "sha384-i4WvSN2jMgQdegnH/ambh8eIPHAyN4AQ8Vx9WJ1KVUQ20FbHZW65XDBOUC52sZFZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.50.0/LICENSE
```

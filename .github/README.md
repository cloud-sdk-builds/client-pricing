...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.692.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.692.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3VpD4euF20bDnjz50lwQxhGdF4/jpmv+5dn1anHpdh4CI2Xa3jD8mpdWeAQTEMF3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.692.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.692.0/index.min.mjs": "sha384-3VpD4euF20bDnjz50lwQxhGdF4/jpmv+5dn1anHpdh4CI2Xa3jD8mpdWeAQTEMF3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.692.0/LICENSE
```

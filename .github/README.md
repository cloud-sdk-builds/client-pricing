...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.180.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.180.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2KwpLWWpZmf+5m3xz99Q6xGbtlZx4EJnW+GbTa5LaRyFJAQGOOseP+oE0SoSvgHq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.180.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.180.0/index.min.mjs": "sha384-2KwpLWWpZmf+5m3xz99Q6xGbtlZx4EJnW+GbTa5LaRyFJAQGOOseP+oE0SoSvgHq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.180.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.47.2).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.47.2/index.min.mjs
```

SRI SHA Hash

```text
sha384-o3S8uooAPxnm46sVr5VjonZFpqD3Hx6h0zBX6hGr3ECGIJnXdv9NwdPnR2ZcJWyX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.47.2/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.47.2/index.min.mjs": "sha384-o3S8uooAPxnm46sVr5VjonZFpqD3Hx6h0zBX6hGr3ECGIJnXdv9NwdPnR2ZcJWyX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.47.2/LICENSE
```

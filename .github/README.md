...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.554.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.554.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eN6lV4dTI5q3sWTXhLKR3M3kMmikuAk7fwleMGG45Q8bHOiiJWMfmXdIICBAxS+6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.554.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.554.0/index.min.mjs": "sha384-eN6lV4dTI5q3sWTXhLKR3M3kMmikuAk7fwleMGG45Q8bHOiiJWMfmXdIICBAxS+6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.554.0/LICENSE
```

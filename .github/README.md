...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.989.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.989.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ILQ/8Ju6bGno/xlA0qTdlr5b1c5XvXHDoV8+KaF/BeSxuUKcptEhokW4+cZDa1Ju
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.989.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.989.0/index.min.mjs": "sha384-ILQ/8Ju6bGno/xlA0qTdlr5b1c5XvXHDoV8+KaF/BeSxuUKcptEhokW4+cZDa1Ju"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.989.0/LICENSE
```

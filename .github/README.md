...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.224.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.224.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KrDn5GcTmWppt0+89erLYYXWOB5iVaySNCLsmPHw02i0KWVO1YxlQmsZYsjVS3EP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.224.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.224.0/index.min.mjs": "sha384-KrDn5GcTmWppt0+89erLYYXWOB5iVaySNCLsmPHw02i0KWVO1YxlQmsZYsjVS3EP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.224.0/LICENSE
```

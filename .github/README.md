...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.994.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.994.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-v2nVNaE7Lmm77fyM39/9bbNauwXwCX8cZA4xOV5tEvQEDc+OBrK79flgL6g/rlQu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.994.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.994.0/index.min.mjs": "sha384-v2nVNaE7Lmm77fyM39/9bbNauwXwCX8cZA4xOV5tEvQEDc+OBrK79flgL6g/rlQu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.994.0/LICENSE
```

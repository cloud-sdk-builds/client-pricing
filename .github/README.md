...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.294.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.294.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-l4GiajSNGxZYuwpvJiwDUhigi0cwc55QL75vTPZTte6Im06EUiROJ/2zJ0VNwtrU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.294.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.294.0/index.min.mjs": "sha384-l4GiajSNGxZYuwpvJiwDUhigi0cwc55QL75vTPZTte6Im06EUiROJ/2zJ0VNwtrU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.294.0/LICENSE
```

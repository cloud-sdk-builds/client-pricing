...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.943.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.943.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YHxAxycCfN2ZmaadT0MDTMWe42A+kzCkuuMN9x1UFX7zZiUFBzyAkq3RKcOt1opI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.943.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.943.0/index.min.mjs": "sha384-YHxAxycCfN2ZmaadT0MDTMWe42A+kzCkuuMN9x1UFX7zZiUFBzyAkq3RKcOt1opI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.943.0/LICENSE
```

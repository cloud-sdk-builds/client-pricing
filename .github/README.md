...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.730.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.730.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-M3a2z6O3CWNHET9k950l//jQHOb45vlsjMPFR6XRgg17dOYYRdprOj1Cu+oAUvaR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.730.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.730.0/index.min.mjs": "sha384-M3a2z6O3CWNHET9k950l//jQHOb45vlsjMPFR6XRgg17dOYYRdprOj1Cu+oAUvaR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.730.0/LICENSE
```

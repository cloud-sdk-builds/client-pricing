...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.231.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.231.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MoIHqbSjzzi9ioD9FN6abCOgElAQQD8H5dWR4MBOge4xuyQbKt+lZAV4IJ/8JvD1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.231.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.231.0/index.min.mjs": "sha384-MoIHqbSjzzi9ioD9FN6abCOgElAQQD8H5dWR4MBOge4xuyQbKt+lZAV4IJ/8JvD1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.231.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.321.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.321.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-AZUzE3xB6H3J5SN8cwuVTrbJGgzhW2HQXqvmNrffb0lDtkWbYSeaMEK0wganKQuO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.321.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.321.1/index.min.mjs": "sha384-AZUzE3xB6H3J5SN8cwuVTrbJGgzhW2HQXqvmNrffb0lDtkWbYSeaMEK0wganKQuO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.321.1/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.212.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.212.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OfdPNU6oklrknr9S0qRwwf42G/YnhXGWGXo/rPuajGYAMB33kwanSg3HxwJyXPzT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.212.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.212.0/index.min.mjs": "sha384-OfdPNU6oklrknr9S0qRwwf42G/YnhXGWGXo/rPuajGYAMB33kwanSg3HxwJyXPzT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.212.0/LICENSE
```

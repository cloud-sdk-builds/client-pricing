...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.196.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.196.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hJ9LtT01IgW5V3tLF0zR4oUUNCNTDytDpohC+B/CVRci0mIOUjeqKz87/WSK83vR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.196.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.196.0/index.min.mjs": "sha384-hJ9LtT01IgW5V3tLF0zR4oUUNCNTDytDpohC+B/CVRci0mIOUjeqKz87/WSK83vR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.196.0/LICENSE
```

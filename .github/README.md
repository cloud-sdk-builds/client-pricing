...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.535.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.535.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xtecaR6a44QFo21Ctvp8ENnVKU1x5mEWu+g0QsnJjk2BkDXjmWZa4oAX+aRkDm47
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.535.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.535.0/index.min.mjs": "sha384-xtecaR6a44QFo21Ctvp8ENnVKU1x5mEWu+g0QsnJjk2BkDXjmWZa4oAX+aRkDm47"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.535.0/LICENSE
```

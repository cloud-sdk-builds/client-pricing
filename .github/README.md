...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.55.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.55.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Q7MX0SjVpQSoyF/9El1OrWGb5af8jlxhaQXHBdSTDbzud3gLMrJDF/Pt1sPrshId
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.55.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.55.0/index.min.mjs": "sha384-Q7MX0SjVpQSoyF/9El1OrWGb5af8jlxhaQXHBdSTDbzud3gLMrJDF/Pt1sPrshId"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.55.0/LICENSE
```

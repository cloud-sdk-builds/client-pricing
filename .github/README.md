...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.303.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.303.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rEZPhlanALK8T77wgLJSh31raOUGtKtzRlv5Y0SnxEs6KCrhs/mQuvFSlZ2KU23v
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.303.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.303.0/index.min.mjs": "sha384-rEZPhlanALK8T77wgLJSh31raOUGtKtzRlv5Y0SnxEs6KCrhs/mQuvFSlZ2KU23v"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.303.0/LICENSE
```

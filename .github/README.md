...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.916.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.916.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zLO0At1CQrE03kvo7FB9CUyTqRIFDrdXFVQs5fHoxKmjT/9DAuF3B78m8Ei/fspu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.916.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.916.0/index.min.mjs": "sha384-zLO0At1CQrE03kvo7FB9CUyTqRIFDrdXFVQs5fHoxKmjT/9DAuF3B78m8Ei/fspu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.916.0/LICENSE
```

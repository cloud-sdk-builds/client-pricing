...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.514.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.514.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8e2t4oQ5LfKzqiy2/slZX187nmxmmNYn6qDBkBOSvrlOcVbCGbbVgXYim2GXNyJG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.514.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.514.0/index.min.mjs": "sha384-8e2t4oQ5LfKzqiy2/slZX187nmxmmNYn6qDBkBOSvrlOcVbCGbbVgXYim2GXNyJG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.514.0/LICENSE
```

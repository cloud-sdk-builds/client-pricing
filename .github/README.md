...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.609.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.609.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cveXSXRKutBJPEg5EzOhELLpEWkIquLR4JlVr/CLezJ3F/M0xWjA5vfbvLkfwjBi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.609.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.609.0/index.min.mjs": "sha384-cveXSXRKutBJPEg5EzOhELLpEWkIquLR4JlVr/CLezJ3F/M0xWjA5vfbvLkfwjBi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.609.0/LICENSE
```

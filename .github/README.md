...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.921.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.921.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fUixfl0C4j3Uov+9v64e1Zt5lVkj0QpC4r+twdBHVjd0Vcu4O3IvCtG27pvr3Th+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.921.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.921.0/index.min.mjs": "sha384-fUixfl0C4j3Uov+9v64e1Zt5lVkj0QpC4r+twdBHVjd0Vcu4O3IvCtG27pvr3Th+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.921.0/LICENSE
```

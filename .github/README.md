...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.465.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.465.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Hf1KFxsuv4x35K6i7U6LGc/jSv3maqnV9aYl+ccYWOGdWBRWuDt/MUQAhK9YOy/l
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.465.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.465.0/index.min.mjs": "sha384-Hf1KFxsuv4x35K6i7U6LGc/jSv3maqnV9aYl+ccYWOGdWBRWuDt/MUQAhK9YOy/l"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.465.0/LICENSE
```

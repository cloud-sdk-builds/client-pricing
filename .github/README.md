...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.886.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.886.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7Yr1dNS40hFiTZWWtSL3aFqS2jmu2qIFsXLMJ3ghKAIVSAUj+3zX90vJCD8TSKTd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.886.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.886.0/index.min.mjs": "sha384-7Yr1dNS40hFiTZWWtSL3aFqS2jmu2qIFsXLMJ3ghKAIVSAUj+3zX90vJCD8TSKTd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.886.0/LICENSE
```

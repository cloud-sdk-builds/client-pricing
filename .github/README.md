...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.817.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.817.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-H6i+SnaJjKuZrHAVhALVP62mn/69iHIxc0xm+QX5X/vKyoHvQLOZZkUiwzT+fPSr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.817.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.817.0/index.min.mjs": "sha384-H6i+SnaJjKuZrHAVhALVP62mn/69iHIxc0xm+QX5X/vKyoHvQLOZZkUiwzT+fPSr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.817.0/LICENSE
```

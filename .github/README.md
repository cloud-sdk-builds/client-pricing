...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.24.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.24.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ydAsYs9A0i5J2SXbVf6cqJPMsMiNJmm4/j92VazdzkEisXrAlXXNfb6c6z/GhJ3x
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.24.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.24.0/index.min.mjs": "sha384-ydAsYs9A0i5J2SXbVf6cqJPMsMiNJmm4/j92VazdzkEisXrAlXXNfb6c6z/GhJ3x"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.24.0/LICENSE
```

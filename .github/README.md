...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.454.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.454.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-I0r9f8JNF9HYanfOXhun10ZyREo/ly+68Wx/f9I3//ASB+pC9sKSG3dBI+ldgR/h
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.454.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.454.0/index.min.mjs": "sha384-I0r9f8JNF9HYanfOXhun10ZyREo/ly+68Wx/f9I3//ASB+pC9sKSG3dBI+ldgR/h"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.454.0/LICENSE
```

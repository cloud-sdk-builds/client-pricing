...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.27.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.27.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bek4zrp4Y05A6gMrfkDbha5O28NlRB/LWuXIOhBGrVxhANQul05ldFDx/UURS0k9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.27.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.27.0/index.min.mjs": "sha384-bek4zrp4Y05A6gMrfkDbha5O28NlRB/LWuXIOhBGrVxhANQul05ldFDx/UURS0k9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.27.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.495.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.495.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5K9qlgegRiGbpLwNuNM4Xeaoi+s8otevZVIPw9re88omypcUyfueNwUbaK74YaJ4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.495.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.495.0/index.min.mjs": "sha384-5K9qlgegRiGbpLwNuNM4Xeaoi+s8otevZVIPw9re88omypcUyfueNwUbaK74YaJ4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.495.0/LICENSE
```

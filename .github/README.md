...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.462.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.462.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TnbaXFoMtYyJCKPyX/8uKH7V7ThnqfqbFuIiNmGW7QeQWUddujNoX2Aawr9NPLGV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.462.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.462.0/index.min.mjs": "sha384-TnbaXFoMtYyJCKPyX/8uKH7V7ThnqfqbFuIiNmGW7QeQWUddujNoX2Aawr9NPLGV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.462.0/LICENSE
```

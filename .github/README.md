...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.408.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.408.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jfuuCasjoaVz5qPcNWQm1uE3Na20w9dXzdUV8xMMvFjSiF3Q483Equ6s1rBCXgHg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.408.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.408.0/index.min.mjs": "sha384-jfuuCasjoaVz5qPcNWQm1uE3Na20w9dXzdUV8xMMvFjSiF3Q483Equ6s1rBCXgHg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.408.0/LICENSE
```

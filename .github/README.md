...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.830.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.830.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rqnozWLH0UxKN/MCsu2rMriOHymCXno8RTwU+Rd+0Rd+lG55VzEPn7gxWSxPh3wE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.830.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.830.0/index.min.mjs": "sha384-rqnozWLH0UxKN/MCsu2rMriOHymCXno8RTwU+Rd+0Rd+lG55VzEPn7gxWSxPh3wE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.830.0/LICENSE
```

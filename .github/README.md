...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.301.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.301.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lM+oulZ8bHdZQCA+pDiy7LQg4jjLZvS6ZZbi7eSANYHqKWr0UM4KVdEEZTSbCy/S
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.301.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.301.0/index.min.mjs": "sha384-lM+oulZ8bHdZQCA+pDiy7LQg4jjLZvS6ZZbi7eSANYHqKWr0UM4KVdEEZTSbCy/S"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.301.0/LICENSE
```

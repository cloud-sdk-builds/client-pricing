...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.913.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.913.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-e7UztNV8iz64UsSzwdeZkCkojAkWTUR69yMQ5pDpX8wlmQHwgFf4ro2ATgYsdqk3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.913.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.913.0/index.min.mjs": "sha384-e7UztNV8iz64UsSzwdeZkCkojAkWTUR69yMQ5pDpX8wlmQHwgFf4ro2ATgYsdqk3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.913.0/LICENSE
```

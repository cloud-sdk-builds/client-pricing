...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.200.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.200.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ggtVFc/7tEzj5nyiq+k5cXmnGgX7W9W4NJbqMIK78KlNbBqHxdU/IhA0EIfsbW+K
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.200.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.200.0/index.min.mjs": "sha384-ggtVFc/7tEzj5nyiq+k5cXmnGgX7W9W4NJbqMIK78KlNbBqHxdU/IhA0EIfsbW+K"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.200.0/LICENSE
```

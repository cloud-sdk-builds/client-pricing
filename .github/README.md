...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.956.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.956.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tMRJRHBX45QDZ/Hra/R8dcNaQRyeiecQeDRFsjGTrbI22inS/EN/Ih5A5l9jbLch
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.956.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.956.0/index.min.mjs": "sha384-tMRJRHBX45QDZ/Hra/R8dcNaQRyeiecQeDRFsjGTrbI22inS/EN/Ih5A5l9jbLch"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.956.0/LICENSE
```

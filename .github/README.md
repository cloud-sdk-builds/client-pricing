...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.649.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.649.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lVOUfgKC6A74LrNRhJf+YOBsYStEn+0q+v4ZLycjA8RsQvCpf7+pVGJ3FMZMzxmf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.649.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.649.0/index.min.mjs": "sha384-lVOUfgKC6A74LrNRhJf+YOBsYStEn+0q+v4ZLycjA8RsQvCpf7+pVGJ3FMZMzxmf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.649.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.651.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.651.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ts08x/0duMndAewegzQTbZCj13lOn7XLLJqfu0t8KoiUBvsClNpp27DQBoWKQd8d
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.651.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.651.1/index.min.mjs": "sha384-Ts08x/0duMndAewegzQTbZCj13lOn7XLLJqfu0t8KoiUBvsClNpp27DQBoWKQd8d"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.651.1/LICENSE
```

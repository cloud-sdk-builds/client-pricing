...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.859.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.859.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/u6uKImhMUZ5EsmVReVOaXdCbo6AxvtFZtnTcenC+88AvrCxH7qlz5fvSlrdWz3Z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.859.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.859.0/index.min.mjs": "sha384-/u6uKImhMUZ5EsmVReVOaXdCbo6AxvtFZtnTcenC+88AvrCxH7qlz5fvSlrdWz3Z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.859.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.980.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.980.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BV8AB07z0p9DrfofVaLyKSSSXvlW4t9oG6TEnyWAmaSTWA2MUIwH6t9HsM9ay2Lg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.980.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.980.0/index.min.mjs": "sha384-BV8AB07z0p9DrfofVaLyKSSSXvlW4t9oG6TEnyWAmaSTWA2MUIwH6t9HsM9ay2Lg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.980.0/LICENSE
```

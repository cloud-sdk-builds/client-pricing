...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.645.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.645.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QcqrGwJnktLBHzw6zxdrT1NQCHp2iReOWEtM5Kguy+lSa0q4oZZJFTd1ByzMrxSm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.645.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.645.0/index.min.mjs": "sha384-QcqrGwJnktLBHzw6zxdrT1NQCHp2iReOWEtM5Kguy+lSa0q4oZZJFTd1ByzMrxSm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.645.0/LICENSE
```

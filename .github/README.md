...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.1022.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1022.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Pmq9nx0P8Yaz4DxWK9gcwJQJA/qxsekc+0fjjyARiPruwh1mVg4EKaPQqT8+SHna
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1022.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1022.0/index.min.mjs": "sha384-Pmq9nx0P8Yaz4DxWK9gcwJQJA/qxsekc+0fjjyARiPruwh1mVg4EKaPQqT8+SHna"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.1022.0/LICENSE
```

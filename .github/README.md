...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.936.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.936.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DCOWz+VKd9dZszv4f13eJDitleqnEI3t+aAamX3mBjY1xmj58iHDhHV3PGsUctNu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.936.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.936.0/index.min.mjs": "sha384-DCOWz+VKd9dZszv4f13eJDitleqnEI3t+aAamX3mBjY1xmj58iHDhHV3PGsUctNu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.936.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.257.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.257.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wF85dPw0TeYFcaMYCB1tIos5qdfkXcrgY10LlFN5pdWNbFdFx9sT9bco8IRdY1eC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.257.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.257.0/index.min.mjs": "sha384-wF85dPw0TeYFcaMYCB1tIos5qdfkXcrgY10LlFN5pdWNbFdFx9sT9bco8IRdY1eC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.257.0/LICENSE
```

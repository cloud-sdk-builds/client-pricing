...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.598.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.598.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jYLKvoca8CKXfLMH9mAocxIh/8K1Hj4z3LLo47C+TP2dZas+bXrQ36mbdKqYwg0N
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.598.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.598.0/index.min.mjs": "sha384-jYLKvoca8CKXfLMH9mAocxIh/8K1Hj4z3LLo47C+TP2dZas+bXrQ36mbdKqYwg0N"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.598.0/LICENSE
```

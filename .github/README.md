...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.891.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.891.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-v0Nb6N4XGFJSmC9X867mBtirFwhH+YpGxFTFMI4LaQAVWWKTP57Lsv1/zWQVVMA5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.891.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.891.0/index.min.mjs": "sha384-v0Nb6N4XGFJSmC9X867mBtirFwhH+YpGxFTFMI4LaQAVWWKTP57Lsv1/zWQVVMA5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.891.0/LICENSE
```

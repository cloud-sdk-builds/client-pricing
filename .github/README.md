...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.501.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.501.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OV7ca/dbpqH4cteIsYgzD31ml11aidGYwJPnCnTUfYZxK9Ju/xccvt65HPbGtcDl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.501.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.501.0/index.min.mjs": "sha384-OV7ca/dbpqH4cteIsYgzD31ml11aidGYwJPnCnTUfYZxK9Ju/xccvt65HPbGtcDl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.501.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.48.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.48.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Hw/aM5mXyQiizoDeJBIOla8b4Te1RIxv0i7iS2Q3eVsbM77bhnM+HmN63Z9ta3DB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.48.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.48.0/index.min.mjs": "sha384-Hw/aM5mXyQiizoDeJBIOla8b4Te1RIxv0i7iS2Q3eVsbM77bhnM+HmN63Z9ta3DB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.48.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.388.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.388.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7mdNbufxHc76Uejz7ZWzphYP5uvVtUK+oC5Z9lbdPhVKRBjdgSPNEdSNGEgjZYB0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.388.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.388.0/index.min.mjs": "sha384-7mdNbufxHc76Uejz7ZWzphYP5uvVtUK+oC5Z9lbdPhVKRBjdgSPNEdSNGEgjZYB0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.388.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.552.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.552.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/sNvngG6kSrTEIr7oeEa93F1mcC19idMcVNuZlPvDtqobhq2TtwWnezhtWAgD34B
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.552.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.552.0/index.min.mjs": "sha384-/sNvngG6kSrTEIr7oeEa93F1mcC19idMcVNuZlPvDtqobhq2TtwWnezhtWAgD34B"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.552.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.183.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.183.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZTSt0ulOW/4EVr5nSIJzUYL+4QI4QDE8EYho+88te2oA4xnhoQcoTIoA9VHfNNc5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.183.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.183.0/index.min.mjs": "sha384-ZTSt0ulOW/4EVr5nSIJzUYL+4QI4QDE8EYho+88te2oA4xnhoQcoTIoA9VHfNNc5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.183.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.775.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.775.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AY2vBjuFoToQK1/Kw0Q7PJBqzz8clXqdGHKATkO1PHmq7EQ1vMSSYwIgNOHRxxES
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.775.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.775.0/index.min.mjs": "sha384-AY2vBjuFoToQK1/Kw0Q7PJBqzz8clXqdGHKATkO1PHmq7EQ1vMSSYwIgNOHRxxES"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.775.0/LICENSE
```

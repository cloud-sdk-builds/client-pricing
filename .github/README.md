...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.245.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.245.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dH9M90P8WFQYVqvwI/8rf0jGlmRtTIK/BCb6MGFysVqKFN1KCWzRHNEzD6mgokgL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.245.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.245.0/index.min.mjs": "sha384-dH9M90P8WFQYVqvwI/8rf0jGlmRtTIK/BCb6MGFysVqKFN1KCWzRHNEzD6mgokgL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.245.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.186.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.186.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kk8LRu8J/TbjoSUuvQrl472z2XhdYtOSdfU2RkXUR2YxeTHE0GYUKn2dBTSWG4Qy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.186.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.186.0/index.min.mjs": "sha384-kk8LRu8J/TbjoSUuvQrl472z2XhdYtOSdfU2RkXUR2YxeTHE0GYUKn2dBTSWG4Qy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.186.0/LICENSE
```

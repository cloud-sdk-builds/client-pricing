...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.883.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.883.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DsmE/vHwmzso6yDTrJ3k1Vy7beD5whBhixI/7k/gyOiqLtGtm2nmqIxhBBDB6lJN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.883.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.883.0/index.min.mjs": "sha384-DsmE/vHwmzso6yDTrJ3k1Vy7beD5whBhixI/7k/gyOiqLtGtm2nmqIxhBBDB6lJN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.883.0/LICENSE
```

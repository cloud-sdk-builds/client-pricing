...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.45.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.45.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-I+DQ9l68oe4TX7tllbVdRlmAobJJlDAIlw/uoSx1QJXLNBQVdw+ZG6F4UM3fZf60
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.45.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.45.0/index.min.mjs": "sha384-I+DQ9l68oe4TX7tllbVdRlmAobJJlDAIlw/uoSx1QJXLNBQVdw+ZG6F4UM3fZf60"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.45.0/LICENSE
```

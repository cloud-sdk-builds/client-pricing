...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.787.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.787.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yuPb6ir6XjN9LzcOiRuX6QabCEQPqfjiMAdCiP378WuAUFJyb7nQop+BFgThqorW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.787.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.787.0/index.min.mjs": "sha384-yuPb6ir6XjN9LzcOiRuX6QabCEQPqfjiMAdCiP378WuAUFJyb7nQop+BFgThqorW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.787.0/LICENSE
```

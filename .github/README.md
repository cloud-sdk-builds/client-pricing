...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.197.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.197.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WX+x5aK8IDjRE34aucgm8ObOW4HZuvlputOO97cpd6yCLog/fg0LqZbn5ekxShu5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.197.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.197.0/index.min.mjs": "sha384-WX+x5aK8IDjRE34aucgm8ObOW4HZuvlputOO97cpd6yCLog/fg0LqZbn5ekxShu5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.197.0/LICENSE
```

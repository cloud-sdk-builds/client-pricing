...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.1013.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1013.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-u0fplQBXMc2/Y1MbigjuJTO4wEEZDskPxn9QzWC+2ROilsWXB3tZIzkxvNJDTZcD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1013.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1013.0/index.min.mjs": "sha384-u0fplQBXMc2/Y1MbigjuJTO4wEEZDskPxn9QzWC+2ROilsWXB3tZIzkxvNJDTZcD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.1013.0/LICENSE
```

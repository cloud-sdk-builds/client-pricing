...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.20.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.20.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yN/uLFmPCZYMdcPm1b0aZNzliyT7r6ewhhy+j02O6L6VHADfnrVawKfEmmvpC1Xj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.20.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.20.0/index.min.mjs": "sha384-yN/uLFmPCZYMdcPm1b0aZNzliyT7r6ewhhy+j02O6L6VHADfnrVawKfEmmvpC1Xj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.20.0/LICENSE
```

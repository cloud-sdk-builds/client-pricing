...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.540.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.540.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6Wm5wbx8FqTrFVn6VvQq+VewdM4ouZIRLWPyvZQAik7cfY4LIP/9mGInqeKDtrps
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.540.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.540.0/index.min.mjs": "sha384-6Wm5wbx8FqTrFVn6VvQq+VewdM4ouZIRLWPyvZQAik7cfY4LIP/9mGInqeKDtrps"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.540.0/LICENSE
```

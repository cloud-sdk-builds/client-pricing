...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.2.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.2.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3seDdi+vs0W3jRayVCCUZa2yfT13iOgnAaj93oGHbpuLa7Wu+/z8Kimw/cqS2Sfl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.2.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.2.0/index.min.mjs": "sha384-3seDdi+vs0W3jRayVCCUZa2yfT13iOgnAaj93oGHbpuLa7Wu+/z8Kimw/cqS2Sfl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.2.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.409.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.409.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hTgysCqlFO5Pm35qFq7ksqpvaWZgcBH8vSABxLRkGjcnXEQ+FbT5MBxkC1PkG68B
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.409.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.409.0/index.min.mjs": "sha384-hTgysCqlFO5Pm35qFq7ksqpvaWZgcBH8vSABxLRkGjcnXEQ+FbT5MBxkC1PkG68B"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.409.0/LICENSE
```

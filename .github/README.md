...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.229.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.229.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aOlyWVSwSqHbly/D/rAWidoxNely8HG5x8xyc2bizEwQ/EIzmtYu5WXN0jHa8JiI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.229.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.229.0/index.min.mjs": "sha384-aOlyWVSwSqHbly/D/rAWidoxNely8HG5x8xyc2bizEwQ/EIzmtYu5WXN0jHa8JiI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.229.0/LICENSE
```

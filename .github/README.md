...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.171.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.171.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zxrsUGIw0Y8PIMY1lEKRUvRDshvLe2Cxjs9JyxOW+m7e9nF5fCY1hOnQVVBweBny
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.171.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.171.0/index.min.mjs": "sha384-zxrsUGIw0Y8PIMY1lEKRUvRDshvLe2Cxjs9JyxOW+m7e9nF5fCY1hOnQVVBweBny"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.171.0/LICENSE
```

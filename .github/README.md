...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.709.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.709.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QeM4khoMtudo2TV7ufxiy834BAwmhLRvEaBylIF0WzOtokBM4KJ4QzgVQsQxWi6K
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.709.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.709.0/index.min.mjs": "sha384-QeM4khoMtudo2TV7ufxiy834BAwmhLRvEaBylIF0WzOtokBM4KJ4QzgVQsQxWi6K"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.709.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.907.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.907.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dZJNELpw8rckI32fOu/chKC8dLQp1gXriydZvbx5bNxaJgOI/1kK3C8+VmKexFMV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.907.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.907.0/index.min.mjs": "sha384-dZJNELpw8rckI32fOu/chKC8dLQp1gXriydZvbx5bNxaJgOI/1kK3C8+VmKexFMV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.907.0/LICENSE
```

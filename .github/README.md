...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.804.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.804.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-29WiPRDHbb5YhICTc5+Xplh8mkge2TF0XkoIRU4pqWSNE80Am7AxzCH2/h4wrkfF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.804.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.804.0/index.min.mjs": "sha384-29WiPRDHbb5YhICTc5+Xplh8mkge2TF0XkoIRU4pqWSNE80Am7AxzCH2/h4wrkfF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.804.0/LICENSE
```

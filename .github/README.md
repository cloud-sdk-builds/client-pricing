...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.363.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.363.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-y5R6h1mlCqnx0+WEP74esRL6KlAvaiUHYF42hlW68Vba4ZcdisaVppqjHJXZ3AxE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.363.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.363.0/index.min.mjs": "sha384-y5R6h1mlCqnx0+WEP74esRL6KlAvaiUHYF42hlW68Vba4ZcdisaVppqjHJXZ3AxE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.363.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.67.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.67.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-y2prf1DnseXLma/HUlynBGtxSmMiM8PqM7k8u3WtTPIwLrDylZmcI0zKkaNXVPBA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.67.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.67.0/index.min.mjs": "sha384-y2prf1DnseXLma/HUlynBGtxSmMiM8PqM7k8u3WtTPIwLrDylZmcI0zKkaNXVPBA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.67.0/LICENSE
```

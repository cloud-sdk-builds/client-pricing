...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.1004.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1004.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SHnjlLT6HI8gKDDDr8FgnEOqYop7MefXP2z8tX0BlPPUUFT7hSGE6MdwQXTRgo5h
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1004.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1004.0/index.min.mjs": "sha384-SHnjlLT6HI8gKDDDr8FgnEOqYop7MefXP2z8tX0BlPPUUFT7hSGE6MdwQXTRgo5h"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.1004.0/LICENSE
```

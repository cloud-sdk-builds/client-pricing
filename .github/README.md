...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.489.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.489.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pkeUoU7XoX2odHly+Tuohwb8Qr+9Oqcc5czWmAiWpfnaJBS85/6NDAJN9aSTRynu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.489.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.489.0/index.min.mjs": "sha384-pkeUoU7XoX2odHly+Tuohwb8Qr+9Oqcc5czWmAiWpfnaJBS85/6NDAJN9aSTRynu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.489.0/LICENSE
```

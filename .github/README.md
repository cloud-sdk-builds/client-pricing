...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.451.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.451.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8+JmFNbBGst4R0bQsBiDWquRKIynAKQjhrks3kck+Zhx48iCmlkVVe+G3Ry9M7SP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.451.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.451.0/index.min.mjs": "sha384-8+JmFNbBGst4R0bQsBiDWquRKIynAKQjhrks3kck+Zhx48iCmlkVVe+G3Ry9M7SP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.451.0/LICENSE
```

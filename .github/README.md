...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.266.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.266.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FPpURrv5+emnWiToxV6gHZjJWhBnQOIAzoU+WiNQbATI+ajTqAsoKC+a9HZxUa4y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.266.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.266.0/index.min.mjs": "sha384-FPpURrv5+emnWiToxV6gHZjJWhBnQOIAzoU+WiNQbATI+ajTqAsoKC+a9HZxUa4y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.266.0/LICENSE
```

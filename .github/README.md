...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.130.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.130.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-P/xi6FbZlEMwQqvuHLVB6mWKvCd9fr2wthDgTtAqrbt48SaE5/I+GBlhhJL4Cv1C
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.130.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.130.0/index.min.mjs": "sha384-P/xi6FbZlEMwQqvuHLVB6mWKvCd9fr2wthDgTtAqrbt48SaE5/I+GBlhhJL4Cv1C"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.130.0/LICENSE
```

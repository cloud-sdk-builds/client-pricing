...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.202.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.202.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gRSrCpYqVTF7Fp0M/MiN8fYDvNivlEUMHT2NuWyYmjk7PzsAdACLR+CBbUNJXze/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.202.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.202.0/index.min.mjs": "sha384-gRSrCpYqVTF7Fp0M/MiN8fYDvNivlEUMHT2NuWyYmjk7PzsAdACLR+CBbUNJXze/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.202.0/LICENSE
```

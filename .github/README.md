...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.3.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.3.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qGuDjX9+ovU+f3qyZv+Kkqf35ruiVhsJrx8pTnnIDdWHnjo5cbTV3392H7aHM6GZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.3.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.3.0/index.min.mjs": "sha384-qGuDjX9+ovU+f3qyZv+Kkqf35ruiVhsJrx8pTnnIDdWHnjo5cbTV3392H7aHM6GZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.3.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.33.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.33.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Yt3mq6XxBA7CVTAYoh0f5cJbbUuxOubffC4S+c8JL1EVmUwWA3+7o5mNoEzsYU85
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.33.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.33.0/index.min.mjs": "sha384-Yt3mq6XxBA7CVTAYoh0f5cJbbUuxOubffC4S+c8JL1EVmUwWA3+7o5mNoEzsYU85"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.33.0/LICENSE
```

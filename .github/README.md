...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.929.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.929.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HaXg/ll+9ZRPyWmGsqicWwBKbaQwb/rk5s7mXlRh+32ZMQfnKvLMBs/lWaKqwAsL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.929.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.929.0/index.min.mjs": "sha384-HaXg/ll+9ZRPyWmGsqicWwBKbaQwb/rk5s7mXlRh+32ZMQfnKvLMBs/lWaKqwAsL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.929.0/LICENSE
```

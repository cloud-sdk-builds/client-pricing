...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.637.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.637.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gmrKmXeNXQRaqotEmtTc3Q4mDpky0uZKY3cKIN6ldEP0ReQsjp6E8K/1JtCppbTu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.637.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.637.0/index.min.mjs": "sha384-gmrKmXeNXQRaqotEmtTc3Q4mDpky0uZKY3cKIN6ldEP0ReQsjp6E8K/1JtCppbTu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.637.0/LICENSE
```

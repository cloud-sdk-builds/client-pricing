...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.901.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.901.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9IzPcAWB9eBKJEBVjgEmkho+1ZBsJ7EceoiQJz+aSWMCOhcBmbmd5Pxh1U9v7rPy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.901.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.901.0/index.min.mjs": "sha384-9IzPcAWB9eBKJEBVjgEmkho+1ZBsJ7EceoiQJz+aSWMCOhcBmbmd5Pxh1U9v7rPy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.901.0/LICENSE
```

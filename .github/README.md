...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.78.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.78.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p8bE8ZLnMJ0mjm6bRSq6Xzh6/5Ox7eKmSu7jVRCuDqJ0G5glzYWrr1MfAxrmjwxF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.78.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.78.0/index.min.mjs": "sha384-p8bE8ZLnMJ0mjm6bRSq6Xzh6/5Ox7eKmSu7jVRCuDqJ0G5glzYWrr1MfAxrmjwxF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.78.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.288.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.288.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IE2wKBuq3ND0fmTC+2hLRMoBOEuGIlF3ZibPQo1rPWCGAwquYYsTFh8Ue1hNw8Lt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.288.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.288.0/index.min.mjs": "sha384-IE2wKBuq3ND0fmTC+2hLRMoBOEuGIlF3ZibPQo1rPWCGAwquYYsTFh8Ue1hNw8Lt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.288.0/LICENSE
```

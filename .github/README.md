...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.0.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.0.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KtYUTfeIEq79bmGxadQcTEQhrR0LBX9B5R+Q8ytzGPfx2e00zbspLQiFUXmmRH0r
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.0.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.0.0/index.min.mjs": "sha384-KtYUTfeIEq79bmGxadQcTEQhrR0LBX9B5R+Q8ytzGPfx2e00zbspLQiFUXmmRH0r"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.0.0/LICENSE
```

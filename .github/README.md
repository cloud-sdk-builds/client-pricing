...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.165.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.165.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Hjwp7OKzxuS25bEvSyDoMRnKGnn43AaDspob/XEj71Vh2GmX0Elh12VYN9QBw1QX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.165.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.165.0/index.min.mjs": "sha384-Hjwp7OKzxuS25bEvSyDoMRnKGnn43AaDspob/XEj71Vh2GmX0Elh12VYN9QBw1QX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.165.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.110.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.110.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-egt8oKGn2MsS6mFM8/C/lVmiFkoLe4mBlrck82eXD6MaCK0ykIDf34K8YsfAdPE4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.110.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.110.0/index.min.mjs": "sha384-egt8oKGn2MsS6mFM8/C/lVmiFkoLe4mBlrck82eXD6MaCK0ykIDf34K8YsfAdPE4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.110.0/LICENSE
```

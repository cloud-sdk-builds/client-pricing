...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.995.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.995.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VnlGvV1tEMX0wylRjT2osLNQziS0oVXZ7Of2/iiNu2+uPrmIhGz5G+/26f4GDvcr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.995.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.995.0/index.min.mjs": "sha384-VnlGvV1tEMX0wylRjT2osLNQziS0oVXZ7Of2/iiNu2+uPrmIhGz5G+/26f4GDvcr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.995.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.58.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.58.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pLFljVSoJOJJ/ZVIs/JCGBy3osin310m+LudTJ4IQQSkCyaNgRLk+vPje4cgl+8T
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.58.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.58.0/index.min.mjs": "sha384-pLFljVSoJOJJ/ZVIs/JCGBy3osin310m+LudTJ4IQQSkCyaNgRLk+vPje4cgl+8T"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.58.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.210.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.210.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uPoE1SXHXkOA38J+Wx0WN2lqX2aL5z1QAnSLo6Cq7D5zjXEF+VDmjgGAwg5NnjDV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.210.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.210.0/index.min.mjs": "sha384-uPoE1SXHXkOA38J+Wx0WN2lqX2aL5z1QAnSLo6Cq7D5zjXEF+VDmjgGAwg5NnjDV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.210.0/LICENSE
```

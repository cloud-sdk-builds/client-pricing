...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.563.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.563.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-avaTgyZr58FRlkbijaZsjI56EQTpD6Vx6N+aVb8UPpRduVpgNY7sDOofKPjIY2rv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.563.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.563.0/index.min.mjs": "sha384-avaTgyZr58FRlkbijaZsjI56EQTpD6Vx6N+aVb8UPpRduVpgNY7sDOofKPjIY2rv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.563.0/LICENSE
```

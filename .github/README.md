...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.254.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.254.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3L03mT+HdqZVAywFECLv5N8XTfE2oZMxvbe10gQviXL/Smq3dVqHCp2JzvzkmDOU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.254.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.254.0/index.min.mjs": "sha384-3L03mT+HdqZVAywFECLv5N8XTfE2oZMxvbe10gQviXL/Smq3dVqHCp2JzvzkmDOU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.254.0/LICENSE
```

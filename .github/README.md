...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.325.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.325.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oUlAOI7auUELKc4R+i7JQXRzaUANUx0g3hHcSDHPS4qM98ZPxn0B2+G61KP1VZjP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.325.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.325.0/index.min.mjs": "sha384-oUlAOI7auUELKc4R+i7JQXRzaUANUx0g3hHcSDHPS4qM98ZPxn0B2+G61KP1VZjP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.325.0/LICENSE
```

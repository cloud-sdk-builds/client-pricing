...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.962.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.962.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aOz3y5g2+etprL78NAI/BxBvyo5VKlyI7UuJ9BvEbPWZJnvJfUR1al3Yc4e1gn95
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.962.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.962.0/index.min.mjs": "sha384-aOz3y5g2+etprL78NAI/BxBvyo5VKlyI7UuJ9BvEbPWZJnvJfUR1al3Yc4e1gn95"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.962.0/LICENSE
```

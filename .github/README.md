...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.338.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.338.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-M+BiI8FFuEAs6dbOV/3iZ/sAJ6kuZPNv/ByEuF1A/HkRooyjHDKwm8RuLp2TJkNu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.338.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.338.0/index.min.mjs": "sha384-M+BiI8FFuEAs6dbOV/3iZ/sAJ6kuZPNv/ByEuF1A/HkRooyjHDKwm8RuLp2TJkNu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.338.0/LICENSE
```

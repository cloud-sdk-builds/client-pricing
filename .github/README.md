...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.386.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.386.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bsMgql/tXczpzBem74fbXIlpSY7nLbqQ/skuYHNU7dhy88ivu1DRiQcr6GV7HXqQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.386.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.386.0/index.min.mjs": "sha384-bsMgql/tXczpzBem74fbXIlpSY7nLbqQ/skuYHNU7dhy88ivu1DRiQcr6GV7HXqQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.386.0/LICENSE
```

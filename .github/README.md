...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.993.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.993.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+RmoXVOKsyMRvqV+EDEfhyxtEZksy1SK9+qDjm+eUnreCFoqK8+NnY8LBUkKrfEj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.993.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.993.0/index.min.mjs": "sha384-+RmoXVOKsyMRvqV+EDEfhyxtEZksy1SK9+qDjm+eUnreCFoqK8+NnY8LBUkKrfEj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.993.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.481.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.481.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4ZKDcTugg2E1C5D3McCSd1bSaxwD04/Dq1y06eMjakzAUEbI3FAkTugiOZEAV4LY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.481.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.481.0/index.min.mjs": "sha384-4ZKDcTugg2E1C5D3McCSd1bSaxwD04/Dq1y06eMjakzAUEbI3FAkTugiOZEAV4LY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.481.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.121.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.121.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NR5BhjWDgI9vo2iEJLgPEBL/Ifz793hWj8sMQmiEkB+YBpRYG/YKeDKg9tXp669Q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.121.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.121.0/index.min.mjs": "sha384-NR5BhjWDgI9vo2iEJLgPEBL/Ifz793hWj8sMQmiEkB+YBpRYG/YKeDKg9tXp669Q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.121.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.712.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.712.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/nCr4r2OHpNnhJKwVPC4/LG2velQdppkvZx4rle3wMOOaLxy2NJrfZ6wkE/qsIXZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.712.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.712.0/index.min.mjs": "sha384-/nCr4r2OHpNnhJKwVPC4/LG2velQdppkvZx4rle3wMOOaLxy2NJrfZ6wkE/qsIXZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.712.0/LICENSE
```

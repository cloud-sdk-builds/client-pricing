...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.990.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.990.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1YCVDiWhrQosNFDWZ2goGXooIOwhqvJ3we1MVEOZpIzQSszz2cYIuv4LFc2+lw7a
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.990.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.990.0/index.min.mjs": "sha384-1YCVDiWhrQosNFDWZ2goGXooIOwhqvJ3we1MVEOZpIzQSszz2cYIuv4LFc2+lw7a"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.990.0/LICENSE
```

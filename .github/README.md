...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.997.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.997.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nzwD9yiIFMc7eXul7tS2jLiOjXKxx+p4qZQonPId2IiVF7rHwDwnhO+jNTCFT0+m
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.997.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.997.0/index.min.mjs": "sha384-nzwD9yiIFMc7eXul7tS2jLiOjXKxx+p4qZQonPId2IiVF7rHwDwnhO+jNTCFT0+m"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.997.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.428.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.428.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-D0uygGaElgZKt0fWOJYsSBinwQ2QcatDeyVccdaH2P7/oHnu4lMhn0w6crm9Uu1E
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.428.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.428.0/index.min.mjs": "sha384-D0uygGaElgZKt0fWOJYsSBinwQ2QcatDeyVccdaH2P7/oHnu4lMhn0w6crm9Uu1E"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.428.0/LICENSE
```

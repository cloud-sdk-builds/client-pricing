...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.54.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.54.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-gyFFAMVfdtWESM1Id7pcWtRqiMjTB8OPJlujgcijt7k1pccII1KnK9UrIOMJSYbo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.54.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.54.1/index.min.mjs": "sha384-gyFFAMVfdtWESM1Id7pcWtRqiMjTB8OPJlujgcijt7k1pccII1KnK9UrIOMJSYbo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.54.1/LICENSE
```

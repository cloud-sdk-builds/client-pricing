...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.782.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.782.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MwXXfUFeFyro0nN55pk5U/27S7POpiXthr+P32JGMPwk/NpKLtf5iP128MseY/N5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.782.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.782.0/index.min.mjs": "sha384-MwXXfUFeFyro0nN55pk5U/27S7POpiXthr+P32JGMPwk/NpKLtf5iP128MseY/N5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.782.0/LICENSE
```

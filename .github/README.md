...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.31.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.31.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XpP405/OKTmnV8AFMNFonSYTLLtFzjZCzwVse6hLrmcddM2jtYLg21X20uP2a/p8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.31.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.31.0/index.min.mjs": "sha384-XpP405/OKTmnV8AFMNFonSYTLLtFzjZCzwVse6hLrmcddM2jtYLg21X20uP2a/p8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.31.0/LICENSE
```

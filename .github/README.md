...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.241.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.241.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xu/3vBfIuaehJ6Wb9vkgUsnsK2PVkcPPKpT2FLF9vJQMD2CRJn4rMoMDgK+Sg2OM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.241.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.241.0/index.min.mjs": "sha384-xu/3vBfIuaehJ6Wb9vkgUsnsK2PVkcPPKpT2FLF9vJQMD2CRJn4rMoMDgK+Sg2OM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.241.0/LICENSE
```

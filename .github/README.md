...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.908.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.908.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-U0di42wlprQr/LA3WWGEdOvRJUWPjndaB/G7uVITmQO7Sz5CI/izAVXCHnYZjx3p
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.908.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.908.0/index.min.mjs": "sha384-U0di42wlprQr/LA3WWGEdOvRJUWPjndaB/G7uVITmQO7Sz5CI/izAVXCHnYZjx3p"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.908.0/LICENSE
```

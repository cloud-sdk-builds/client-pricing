...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.300.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.300.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IcZfDUp/GJ5zIlOh/WsYTii2DflaU4heBkzi7fegVwVCWy6YMGUtXCXNf0ph4+RP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.300.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.300.0/index.min.mjs": "sha384-IcZfDUp/GJ5zIlOh/WsYTii2DflaU4heBkzi7fegVwVCWy6YMGUtXCXNf0ph4+RP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.300.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.80.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.80.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SMJGqrGyYXl3w91U+KHLic7PuP58szaaPO5ofeZ62TMIIYpTzTWmULWlci+NjOBf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.80.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.80.0/index.min.mjs": "sha384-SMJGqrGyYXl3w91U+KHLic7PuP58szaaPO5ofeZ62TMIIYpTzTWmULWlci+NjOBf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.80.0/LICENSE
```

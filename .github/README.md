...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.8.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.8.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-sYnTbv0rhZEEYhvOH4muZKmE+7YZo0vw5ihgwPM2inZ/bHOO4RxyEtdjjRdFHpOK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.8.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.8.1/index.min.mjs": "sha384-sYnTbv0rhZEEYhvOH4muZKmE+7YZo0vw5ihgwPM2inZ/bHOO4RxyEtdjjRdFHpOK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.8.1/LICENSE
```

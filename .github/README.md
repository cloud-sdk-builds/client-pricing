...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.468.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.468.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ivWukOHOr11XcJ6iT+ZspwP11nSUi3Wu9J8IUeSbeUMB0NYqRp8ouayN0RJsBaar
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.468.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.468.0/index.min.mjs": "sha384-ivWukOHOr11XcJ6iT+ZspwP11nSUi3Wu9J8IUeSbeUMB0NYqRp8ouayN0RJsBaar"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.468.0/LICENSE
```

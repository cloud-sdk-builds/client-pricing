...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.1030.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1030.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-z77cSDawofBx8Es3kh/3OJDOP7eda0+Oz6YLFZoQNM6FxRMawJgCf8JVlST8IKmH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1030.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1030.0/index.min.mjs": "sha384-z77cSDawofBx8Es3kh/3OJDOP7eda0+Oz6YLFZoQNM6FxRMawJgCf8JVlST8IKmH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.1030.0/LICENSE
```

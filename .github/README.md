...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.583.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.583.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9PAV/mxaHY6fZ3LCz36AA3QjGvG9fx9obGHwxlVLCjdD7Z43azTMoCjuZOsmYtUd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.583.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.583.0/index.min.mjs": "sha384-9PAV/mxaHY6fZ3LCz36AA3QjGvG9fx9obGHwxlVLCjdD7Z43azTMoCjuZOsmYtUd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.583.0/LICENSE
```

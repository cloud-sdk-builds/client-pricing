...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.235.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.235.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-t/NrHBno5YLZDnBpPVK6qrC/BO7nHiaiYsnKieFoHQ6em7RbXdRCCqP1eFtbvgOC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.235.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.235.0/index.min.mjs": "sha384-t/NrHBno5YLZDnBpPVK6qrC/BO7nHiaiYsnKieFoHQ6em7RbXdRCCqP1eFtbvgOC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.235.0/LICENSE
```

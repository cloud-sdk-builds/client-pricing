...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.569.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.569.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VBHbaPWLYryBTSY4UPkMid4Yo3U5tpxJR02CsYY/2Dsy+P1T6GbVJtLG4OJDmjEp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.569.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.569.0/index.min.mjs": "sha384-VBHbaPWLYryBTSY4UPkMid4Yo3U5tpxJR02CsYY/2Dsy+P1T6GbVJtLG4OJDmjEp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.569.0/LICENSE
```

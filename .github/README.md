...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.620.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.620.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-37NLEeFB1Yjs4uUAi0GYo+JM3re2UQr6gagHi3e2K9rVnaxCXSp3v/U65HHqZ9xe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.620.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.620.0/index.min.mjs": "sha384-37NLEeFB1Yjs4uUAi0GYo+JM3re2UQr6gagHi3e2K9rVnaxCXSp3v/U65HHqZ9xe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.620.0/LICENSE
```

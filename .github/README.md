...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.1036.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1036.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/RWqOhjIr175k9EhcYcqX7cH0vztM+GQAER0utwDQAia3600elfOqG7ouZa9Y6A7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1036.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1036.0/index.min.mjs": "sha384-/RWqOhjIr175k9EhcYcqX7cH0vztM+GQAER0utwDQAia3600elfOqG7ouZa9Y6A7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.1036.0/LICENSE
```

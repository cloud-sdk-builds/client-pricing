...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.606.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.606.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nSGlaeC4g6eny8ZlazX/DWhmV3IlOwX4Ndb/2+R/9W2D+iGpa6o/MGSs8jJAoPzM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.606.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.606.0/index.min.mjs": "sha384-nSGlaeC4g6eny8ZlazX/DWhmV3IlOwX4Ndb/2+R/9W2D+iGpa6o/MGSs8jJAoPzM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.606.0/LICENSE
```

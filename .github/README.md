...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.316.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.316.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8HLPnaCdT6InySNIgG9pnJS8Axr4kx3PitoYRZPqf4CYTQ4cWiHxgvATEKxktCEE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.316.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.316.0/index.min.mjs": "sha384-8HLPnaCdT6InySNIgG9pnJS8Axr4kx3PitoYRZPqf4CYTQ4cWiHxgvATEKxktCEE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.316.0/LICENSE
```

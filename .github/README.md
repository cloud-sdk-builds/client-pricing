...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.470.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.470.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1CJA0qoTlYdCt7TovHJRg6I8yGFVob6gvyvarZ5p8eIlyWhp/CYxW6RVt5Z1Gi/p
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.470.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.470.0/index.min.mjs": "sha384-1CJA0qoTlYdCt7TovHJRg6I8yGFVob6gvyvarZ5p8eIlyWhp/CYxW6RVt5Z1Gi/p"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.470.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.696.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.696.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zOUvVSeTjYytIViXn67Nhf18BmxPnBxjGUew7OHiceBb32dzksHii5093h5Gs2kw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.696.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.696.0/index.min.mjs": "sha384-zOUvVSeTjYytIViXn67Nhf18BmxPnBxjGUew7OHiceBb32dzksHii5093h5Gs2kw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.696.0/LICENSE
```

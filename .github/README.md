...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.533.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.533.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VDRbqp283FI+OEudITC5SJCsRWSHcwsnh+q3codSKzMgZ00ELbCWSNeNxiKr6sF8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.533.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.533.0/index.min.mjs": "sha384-VDRbqp283FI+OEudITC5SJCsRWSHcwsnh+q3codSKzMgZ00ELbCWSNeNxiKr6sF8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.533.0/LICENSE
```

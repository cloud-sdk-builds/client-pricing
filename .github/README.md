...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.575.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.575.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-queXTKcZYi5dlsjA+fSDqvDX4Xgj2U47m5AZTPLtGSPRXEPTeE20Ss4vHqPGpl/w
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.575.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.575.0/index.min.mjs": "sha384-queXTKcZYi5dlsjA+fSDqvDX4Xgj2U47m5AZTPLtGSPRXEPTeE20Ss4vHqPGpl/w"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.575.0/LICENSE
```

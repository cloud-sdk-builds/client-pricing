...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.150.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.150.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jO5kP4qqy4tjrUs7ureNu/g4XakWTfsGXCOTBapfUNH3qVVf5fRBA1n47rVkB5GP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.150.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.150.0/index.min.mjs": "sha384-jO5kP4qqy4tjrUs7ureNu/g4XakWTfsGXCOTBapfUNH3qVVf5fRBA1n47rVkB5GP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.150.0/LICENSE
```

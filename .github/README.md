...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.777.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.777.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qxUsruDDUQIQhBKP2xNoIlsDIbpZLgq5CsN2/UwvVjX+CeZrcy/eKz0lS6p4uoHN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.777.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.777.0/index.min.mjs": "sha384-qxUsruDDUQIQhBKP2xNoIlsDIbpZLgq5CsN2/UwvVjX+CeZrcy/eKz0lS6p4uoHN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.777.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.262.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.262.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-v+t+lZmFNyp0OFaUbELenIem3SjPsZWBmXH+ovSBlmySgIKHcwVYliK5kxEPUMv2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.262.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.262.0/index.min.mjs": "sha384-v+t+lZmFNyp0OFaUbELenIem3SjPsZWBmXH+ovSBlmySgIKHcwVYliK5kxEPUMv2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.262.0/LICENSE
```

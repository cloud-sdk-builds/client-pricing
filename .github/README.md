...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.259.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.259.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-y6eH234yVFF3Kl046raSVG13XYlo6FF8kbuJZgnQCnigkb2YhpOerg4UjVlq/co3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.259.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.259.0/index.min.mjs": "sha384-y6eH234yVFF3Kl046raSVG13XYlo6FF8kbuJZgnQCnigkb2YhpOerg4UjVlq/co3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.259.0/LICENSE
```

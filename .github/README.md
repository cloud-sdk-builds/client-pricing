...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.289.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.289.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2/XgNyC6kjpQoRq+HjiDSHce5sGcYVjXh0gRBN5LlX5QEGWf5J2GDjzDIpI1bcBD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.289.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.289.0/index.min.mjs": "sha384-2/XgNyC6kjpQoRq+HjiDSHce5sGcYVjXh0gRBN5LlX5QEGWf5J2GDjzDIpI1bcBD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.289.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.385.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.385.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fXbwR1LH9Vcr8RG0OQ4szpJCkcys0my+GzSMuhh/soitvHwQW4GFtRIRJKbJXauM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.385.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.385.0/index.min.mjs": "sha384-fXbwR1LH9Vcr8RG0OQ4szpJCkcys0my+GzSMuhh/soitvHwQW4GFtRIRJKbJXauM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.385.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.1014.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1014.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WOiniNYWeZ0CJxHK006JlM1dasqxErZlIHwCoriBH5SYpi8Tl7UMcOxocUFYH+KJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1014.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1014.0/index.min.mjs": "sha384-WOiniNYWeZ0CJxHK006JlM1dasqxErZlIHwCoriBH5SYpi8Tl7UMcOxocUFYH+KJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.1014.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.666.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.666.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QbTIAbA5lUclpkej1iPO/TZkTPPxJMjpiq4U10s3HpNiIBMulcl3K8xPCWQTrb9h
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.666.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.666.0/index.min.mjs": "sha384-QbTIAbA5lUclpkej1iPO/TZkTPPxJMjpiq4U10s3HpNiIBMulcl3K8xPCWQTrb9h"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.666.0/LICENSE
```

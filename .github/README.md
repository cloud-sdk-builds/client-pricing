...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.920.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.920.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Chj6qAcDciuiHmmOwIq2IQPbJfZdUV8xicoya+4QR1F7wKFEXRALQhTScdL+bM+L
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.920.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.920.0/index.min.mjs": "sha384-Chj6qAcDciuiHmmOwIq2IQPbJfZdUV8xicoya+4QR1F7wKFEXRALQhTScdL+bM+L"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.920.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.11.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.11.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vBeV5jqoW0/zdIeI6Q4P9HOQPdxZSyRLZTn1QCbBbb4GjFrrmpYVRi+MYb6YVwZ4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.11.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.11.0/index.min.mjs": "sha384-vBeV5jqoW0/zdIeI6Q4P9HOQPdxZSyRLZTn1QCbBbb4GjFrrmpYVRi+MYb6YVwZ4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.11.0/LICENSE
```

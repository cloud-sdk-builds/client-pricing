...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.266.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.266.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-aKJ1BOASlL0/hiB3HFgjuBd6xNQI/TG3l4BpkOgnjkmKxpqgSwl8VVS5K62frI+Y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.266.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.266.1/index.min.mjs": "sha384-aKJ1BOASlL0/hiB3HFgjuBd6xNQI/TG3l4BpkOgnjkmKxpqgSwl8VVS5K62frI+Y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.266.1/LICENSE
```

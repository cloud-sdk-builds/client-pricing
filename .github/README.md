...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.572.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.572.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Z8eHmc9RIwqZAWMc0T0CfHqYQUfPu9dZT9sIGjbMu3RS1EQ2nRh9j+KbJ27gi4g1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.572.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.572.0/index.min.mjs": "sha384-Z8eHmc9RIwqZAWMc0T0CfHqYQUfPu9dZT9sIGjbMu3RS1EQ2nRh9j+KbJ27gi4g1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.572.0/LICENSE
```

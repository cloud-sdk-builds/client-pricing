...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.670.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.670.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-T445ay+zLdo9LWsM/dX7p3Lf9DBd6CK5MDGpOXWLj8vohI0phDfD6uqzRNUsHMQi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.670.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.670.0/index.min.mjs": "sha384-T445ay+zLdo9LWsM/dX7p3Lf9DBd6CK5MDGpOXWLj8vohI0phDfD6uqzRNUsHMQi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.670.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.686.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.686.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vYCJVF/mVktFNDZ/8m68JYghea2Xgr64f3asc6qNartxtg5ntxpLMpVmzAKUVoA5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.686.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.686.0/index.min.mjs": "sha384-vYCJVF/mVktFNDZ/8m68JYghea2Xgr64f3asc6qNartxtg5ntxpLMpVmzAKUVoA5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.686.0/LICENSE
```

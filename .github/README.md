...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.445.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.445.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fkrPFCgv9l05h6fN2QcqxxTok/lftj0TA0zLt0AHOXCrYcr3phv6H4KQUG12ty7Q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.445.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.445.0/index.min.mjs": "sha384-fkrPFCgv9l05h6fN2QcqxxTok/lftj0TA0zLt0AHOXCrYcr3phv6H4KQUG12ty7Q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.445.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.199.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.199.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cTFBHhkQBkzfc8iqDpJrRLrdexhO3o1yApooSf0K+PTWcEccXQQD57kVzTOBG59T
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.199.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.199.0/index.min.mjs": "sha384-cTFBHhkQBkzfc8iqDpJrRLrdexhO3o1yApooSf0K+PTWcEccXQQD57kVzTOBG59T"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.199.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.377.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.377.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-On2ptRy+nz4/igP/LAX/h7G5Zi0g12V8xcOhmXlCAPDC3KGiHAY4acGAr7kkhzqW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.377.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.377.0/index.min.mjs": "sha384-On2ptRy+nz4/igP/LAX/h7G5Zi0g12V8xcOhmXlCAPDC3KGiHAY4acGAr7kkhzqW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.377.0/LICENSE
```

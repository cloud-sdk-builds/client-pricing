...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.808.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.808.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cILekXH+Udtj1njn1978lHK22uAzUbDK3s331qEg68p7T08tOiaMR5KuFuuZX/ln
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.808.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.808.0/index.min.mjs": "sha384-cILekXH+Udtj1njn1978lHK22uAzUbDK3s331qEg68p7T08tOiaMR5KuFuuZX/ln"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.808.0/LICENSE
```

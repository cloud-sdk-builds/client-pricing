...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.741.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.741.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3/vQQq74Ov4wapLTOJejdc3Xcup2J/QzwGI9EM9XT+O8TZaJ87uPElsCgtoLN2vv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.741.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.741.0/index.min.mjs": "sha384-3/vQQq74Ov4wapLTOJejdc3Xcup2J/QzwGI9EM9XT+O8TZaJ87uPElsCgtoLN2vv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.741.0/LICENSE
```

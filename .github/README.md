...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.975.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.975.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SGxoLef90HBBaIe2Qajha0TYscQxWpBgdUKynGGFo6dC2QIhA3bruMcdNgXPGE5D
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.975.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.975.0/index.min.mjs": "sha384-SGxoLef90HBBaIe2Qajha0TYscQxWpBgdUKynGGFo6dC2QIhA3bruMcdNgXPGE5D"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.975.0/LICENSE
```

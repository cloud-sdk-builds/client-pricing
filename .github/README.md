...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.525.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.525.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9Zi71+2JiRBKgcZa/rJSCJhTHng4non/7UvaDj+6iKMHaYM/5RqUm7pQ3IrzjDDN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.525.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.525.0/index.min.mjs": "sha384-9Zi71+2JiRBKgcZa/rJSCJhTHng4non/7UvaDj+6iKMHaYM/5RqUm7pQ3IrzjDDN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.525.0/LICENSE
```

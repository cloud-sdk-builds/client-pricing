...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.574.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.574.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mvk76WJqYHfEj9Y6b+6p7zeP4tA9EX3xH7Dw+7H8bWmHh/RFyN+DJys+b0j+hbZN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.574.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.574.0/index.min.mjs": "sha384-mvk76WJqYHfEj9Y6b+6p7zeP4tA9EX3xH7Dw+7H8bWmHh/RFyN+DJys+b0j+hbZN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.574.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.105.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.105.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GHLBz2Qzv4ejBTGv8ZGj7aWs1E+sKthb4BJCnQDn2QJ4NIRD+ZUiPXdoZ1chGlfB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.105.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.105.0/index.min.mjs": "sha384-GHLBz2Qzv4ejBTGv8ZGj7aWs1E+sKthb4BJCnQDn2QJ4NIRD+ZUiPXdoZ1chGlfB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.105.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.413.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.413.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bf99vnwLOxPioBpHwdNfZ5DfI81BznABKBe1SZmobF4wZRfksOg7GnhDSZpEuNS2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.413.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.413.0/index.min.mjs": "sha384-bf99vnwLOxPioBpHwdNfZ5DfI81BznABKBe1SZmobF4wZRfksOg7GnhDSZpEuNS2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.413.0/LICENSE
```

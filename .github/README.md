...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.928.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.928.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zqlu9OlW/SANq8/EWVUyjyIFrFwVkjBYCsVgiVPgHqs1nm7N2J8NozbXwQUeLq/R
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.928.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.928.0/index.min.mjs": "sha384-zqlu9OlW/SANq8/EWVUyjyIFrFwVkjBYCsVgiVPgHqs1nm7N2J8NozbXwQUeLq/R"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.928.0/LICENSE
```

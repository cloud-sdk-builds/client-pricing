...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.56.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.56.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EqHSk6gnehJqhI8GiZFp959EBC/0lw21IgoCfg1i023tvzTb0o7m4MEoLt7s4ARP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.56.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.56.0/index.min.mjs": "sha384-EqHSk6gnehJqhI8GiZFp959EBC/0lw21IgoCfg1i023tvzTb0o7m4MEoLt7s4ARP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.56.0/LICENSE
```

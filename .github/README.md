...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.414.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.414.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bA/MbmjNcZWy+Qm4ZfWerlpXmzNJgRKf60kPYxO74kClsKbDj2oSlrkAKkl7z9jd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.414.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.414.0/index.min.mjs": "sha384-bA/MbmjNcZWy+Qm4ZfWerlpXmzNJgRKf60kPYxO74kClsKbDj2oSlrkAKkl7z9jd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.414.0/LICENSE
```

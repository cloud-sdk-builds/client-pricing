...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.163.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.163.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rLi9Dbu4lTSjdFPGyxWNzQKKE71gQLaNmSRJXxFi0JxdCLaT8o4nZKcl8dUJc8ay
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.163.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.163.0/index.min.mjs": "sha384-rLi9Dbu4lTSjdFPGyxWNzQKKE71gQLaNmSRJXxFi0JxdCLaT8o4nZKcl8dUJc8ay"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.163.0/LICENSE
```

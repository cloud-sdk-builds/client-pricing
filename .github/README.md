...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.315.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.315.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-W88GoGD3aS9o3b3Hh5w0PofbSW2BSwiVpZbt/5UPoTUHOS6aqIrYTnGFqXdLwlMu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.315.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.315.0/index.min.mjs": "sha384-W88GoGD3aS9o3b3Hh5w0PofbSW2BSwiVpZbt/5UPoTUHOS6aqIrYTnGFqXdLwlMu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.315.0/LICENSE
```

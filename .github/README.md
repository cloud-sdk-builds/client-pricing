...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.499.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.499.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XufM9k2Cth9IcDozj2uuQuuGpYca6UYiNJm86vYkkzH2oosRT9B9KCPxmf2MKHiy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.499.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.499.0/index.min.mjs": "sha384-XufM9k2Cth9IcDozj2uuQuuGpYca6UYiNJm86vYkkzH2oosRT9B9KCPxmf2MKHiy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.499.0/LICENSE
```

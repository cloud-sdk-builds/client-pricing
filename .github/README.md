...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.810.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.810.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YK+g0/ZHrCeqAt4ATmL9P7qW+nbrzbvoLBuL1dxuWNyexJwzTTqb6Mj0WX4+5QDW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.810.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.810.0/index.min.mjs": "sha384-YK+g0/ZHrCeqAt4ATmL9P7qW+nbrzbvoLBuL1dxuWNyexJwzTTqb6Mj0WX4+5QDW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.810.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.328.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.328.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RL1kRWrLLDouj3CyM6vfwtKcl2WJ0lwrSwLCGGjRcfkXwNxsUOw7FHog1/E/p9BN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.328.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.328.0/index.min.mjs": "sha384-RL1kRWrLLDouj3CyM6vfwtKcl2WJ0lwrSwLCGGjRcfkXwNxsUOw7FHog1/E/p9BN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.328.0/LICENSE
```

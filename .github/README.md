...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.930.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.930.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-W3fkhcaU+UjPsh3ERdv3A1iK1lE4fL7RB1h4lyHYy7HNnK16/Uv9HBchQRi18oni
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.930.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.930.0/index.min.mjs": "sha384-W3fkhcaU+UjPsh3ERdv3A1iK1lE4fL7RB1h4lyHYy7HNnK16/Uv9HBchQRi18oni"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.930.0/LICENSE
```

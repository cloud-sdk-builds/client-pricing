...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.195.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.195.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-N09SNXsvSIliKZGSsYnBkSqEK1ynRWYK/00/q/sKs0iw7BBzmaXZbiAXyEMqD3Q8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.195.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.195.0/index.min.mjs": "sha384-N09SNXsvSIliKZGSsYnBkSqEK1ynRWYK/00/q/sKs0iw7BBzmaXZbiAXyEMqD3Q8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.195.0/LICENSE
```

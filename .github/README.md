...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.662.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.662.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KohvonJSjWsRgMc5C7gI0Kz3Iv1fBFW5djosPJS46uZXHqdw2th9HqGa+4oJIO2x
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.662.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.662.0/index.min.mjs": "sha384-KohvonJSjWsRgMc5C7gI0Kz3Iv1fBFW5djosPJS46uZXHqdw2th9HqGa+4oJIO2x"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.662.0/LICENSE
```

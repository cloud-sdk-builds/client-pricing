...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.216.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.216.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2JBEQeor6w0uLxoY0xoTzNh5ry1G3wFNgjElbIx0K0fX/WSS+JiFsExlw4jRJflw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.216.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.216.0/index.min.mjs": "sha384-2JBEQeor6w0uLxoY0xoTzNh5ry1G3wFNgjElbIx0K0fX/WSS+JiFsExlw4jRJflw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.216.0/LICENSE
```

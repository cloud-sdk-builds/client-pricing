...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.17.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.17.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WlbRdHey8jQ3HOXhX6a2/hmEFJ1PsWxhZGNj12GJyvoK2yuwx1x1cY5Ejb7fnAmz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.17.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.17.0/index.min.mjs": "sha384-WlbRdHey8jQ3HOXhX6a2/hmEFJ1PsWxhZGNj12GJyvoK2yuwx1x1cY5Ejb7fnAmz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.17.0/LICENSE
```

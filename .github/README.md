...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.359.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.359.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sMilaliM6y7sGImDyPhwAYWXz6Y7x/sXj0CrEkwCIA8KkdPJmQDVSZCbNtfqTjFn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.359.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.359.0/index.min.mjs": "sha384-sMilaliM6y7sGImDyPhwAYWXz6Y7x/sXj0CrEkwCIA8KkdPJmQDVSZCbNtfqTjFn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.359.0/LICENSE
```

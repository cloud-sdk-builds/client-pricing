...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.919.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.919.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VB2FCIYNcfTjz0K7LnIOOI6BsAIFUhkVV1SSgEC8EV5isz4mvPZ+PzTUZDDQcs7p
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.919.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.919.0/index.min.mjs": "sha384-VB2FCIYNcfTjz0K7LnIOOI6BsAIFUhkVV1SSgEC8EV5isz4mvPZ+PzTUZDDQcs7p"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.919.0/LICENSE
```

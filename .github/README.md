...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.234.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.234.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5pm7GM9H1TdbrDhbdeU1GiS6Jji9JCHzmNLm/fRDe6MAUsK48EDthtkl6D3CLMOX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.234.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.234.0/index.min.mjs": "sha384-5pm7GM9H1TdbrDhbdeU1GiS6Jji9JCHzmNLm/fRDe6MAUsK48EDthtkl6D3CLMOX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.234.0/LICENSE
```

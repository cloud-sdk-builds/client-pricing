...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.226.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.226.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Qv3TrXCPMXbGEhbUcUb92YT/ItuZar3EfGnm4p49gT59LjlyElIgacZB8OkiLOBf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.226.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.226.0/index.min.mjs": "sha384-Qv3TrXCPMXbGEhbUcUb92YT/ItuZar3EfGnm4p49gT59LjlyElIgacZB8OkiLOBf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.226.0/LICENSE
```

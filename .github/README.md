...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.947.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.947.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gixHqPW7+oKyAOjG1FqG8mJnq5YmBIXpPL39P9cdVJ1ls366Mh5AMKeFWmg3CKWN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.947.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.947.0/index.min.mjs": "sha384-gixHqPW7+oKyAOjG1FqG8mJnq5YmBIXpPL39P9cdVJ1ls366Mh5AMKeFWmg3CKWN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.947.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.99.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.99.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RHR/1gvXgO1TDOnywFc1ooe6+PDEE0Q7HQ7ET9uQRfQfgh7Ze+sFnk4+OLN9QxRa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.99.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.99.0/index.min.mjs": "sha384-RHR/1gvXgO1TDOnywFc1ooe6+PDEE0Q7HQ7ET9uQRfQfgh7Ze+sFnk4+OLN9QxRa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.99.0/LICENSE
```

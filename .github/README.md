...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.215.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.215.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UY/SeXUmXAFjqei9txb1PTmRnOvkVeXoev/VykdpTYG9WCPH7LoGaZk1pZXZmGWJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.215.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.215.0/index.min.mjs": "sha384-UY/SeXUmXAFjqei9txb1PTmRnOvkVeXoev/VykdpTYG9WCPH7LoGaZk1pZXZmGWJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.215.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.912.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.912.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XxBku4f6P4UX9A3FUVpkNAdSYdXI6gJdHgfJ66ctnf41iGIDgzW2ZsDPKi//RttL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.912.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.912.0/index.min.mjs": "sha384-XxBku4f6P4UX9A3FUVpkNAdSYdXI6gJdHgfJ66ctnf41iGIDgzW2ZsDPKi//RttL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.912.0/LICENSE
```

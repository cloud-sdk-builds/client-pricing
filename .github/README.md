...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.613.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.613.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DMrU5v+sqw+8ZfkoDDYy2bjGj/UyJKcThEu0+1p9j5xTLly+6arwVYlrUlfQHeoB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.613.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.613.0/index.min.mjs": "sha384-DMrU5v+sqw+8ZfkoDDYy2bjGj/UyJKcThEu0+1p9j5xTLly+6arwVYlrUlfQHeoB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.613.0/LICENSE
```

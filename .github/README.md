...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.450.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.450.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-J+XNwdgsRHfLGr7kCq0JOqYIr4ViG/ruITz9RcuvnsNzj5b5cP41RR87X+/YRQea
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.450.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.450.0/index.min.mjs": "sha384-J+XNwdgsRHfLGr7kCq0JOqYIr4ViG/ruITz9RcuvnsNzj5b5cP41RR87X+/YRQea"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.450.0/LICENSE
```

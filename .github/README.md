...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.10.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.10.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IiyF5FUdXn2bGBDnpy8YfxU/1wI0C3s/7t1AujrTjyl59hAaYjUMdA9hTCVOfO9J
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.10.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.10.0/index.min.mjs": "sha384-IiyF5FUdXn2bGBDnpy8YfxU/1wI0C3s/7t1AujrTjyl59hAaYjUMdA9hTCVOfO9J"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.10.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.310.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.310.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-L5iGyNhjM0mqebAsR8c7D35rUCLQfD9PraRymvKsYM6VrrKqBM92s2KlUCyyoEtw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.310.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.310.0/index.min.mjs": "sha384-L5iGyNhjM0mqebAsR8c7D35rUCLQfD9PraRymvKsYM6VrrKqBM92s2KlUCyyoEtw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.310.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.984.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.984.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WVLfzAPUU1ywH9997NzNyOZGHQu5zBO9j1AZy1H0Z/MBXhdadFnQye8JeAeIOf3f
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.984.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.984.0/index.min.mjs": "sha384-WVLfzAPUU1ywH9997NzNyOZGHQu5zBO9j1AZy1H0Z/MBXhdadFnQye8JeAeIOf3f"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.984.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.971.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.971.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wdo+SMCLttkmuw9DPk4tiC4nPCVl2OisaWui+aeb9rCYqKtOs64p2cU+JJoOhkuO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.971.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.971.0/index.min.mjs": "sha384-wdo+SMCLttkmuw9DPk4tiC4nPCVl2OisaWui+aeb9rCYqKtOs64p2cU+JJoOhkuO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.971.0/LICENSE
```

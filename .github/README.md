...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.845.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.845.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-loTUy1KijXxgm50nNG6/bTtr9kFvKomaKiDYKThBJV51MdwkPGU9YgG+qLTXRrSr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.845.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.845.0/index.min.mjs": "sha384-loTUy1KijXxgm50nNG6/bTtr9kFvKomaKiDYKThBJV51MdwkPGU9YgG+qLTXRrSr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.845.0/LICENSE
```

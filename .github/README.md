...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.378.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.378.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5mKgEDddTbNb2uFgaVrj9rxcza+NUd/dSw+bxK0pQGZ+qI0Z5NKH5XFHbdSGPZJh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.378.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.378.0/index.min.mjs": "sha384-5mKgEDddTbNb2uFgaVrj9rxcza+NUd/dSw+bxK0pQGZ+qI0Z5NKH5XFHbdSGPZJh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.378.0/LICENSE
```

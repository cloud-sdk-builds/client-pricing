...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.855.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.855.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pYF+iOGHyXDVl4BrBqSlZ8MgD4GBgH07M0oaf8Tq3p7PhEPNvTPS7h5ok3Fix5Gz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.855.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.855.0/index.min.mjs": "sha384-pYF+iOGHyXDVl4BrBqSlZ8MgD4GBgH07M0oaf8Tq3p7PhEPNvTPS7h5ok3Fix5Gz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.855.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.298.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.298.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JmNWp9Zj9UHQdpyYXqytZO15BQqUWR9AslguD/QmrWFF8MFYeKgbW9YyNd7qdZXM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.298.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.298.0/index.min.mjs": "sha384-JmNWp9Zj9UHQdpyYXqytZO15BQqUWR9AslguD/QmrWFF8MFYeKgbW9YyNd7qdZXM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.298.0/LICENSE
```

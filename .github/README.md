...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.34.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.34.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-C7Cwc56k3W51qciI6/bu5UgZ+Zt/VzyTXmQDPQh3Kc8VF4cV0cEz43sgV+KShD/f
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.34.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.34.0/index.min.mjs": "sha384-C7Cwc56k3W51qciI6/bu5UgZ+Zt/VzyTXmQDPQh3Kc8VF4cV0cEz43sgV+KShD/f"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.34.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.992.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.992.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VLgHtsOSr9yhTxBcEFXdalvX81DgD/Pwc2gEXeN+UKEn9eW6GohDnjkhgG/uhUjV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.992.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.992.0/index.min.mjs": "sha384-VLgHtsOSr9yhTxBcEFXdalvX81DgD/Pwc2gEXeN+UKEn9eW6GohDnjkhgG/uhUjV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.992.0/LICENSE
```

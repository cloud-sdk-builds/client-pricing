...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.978.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.978.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gmlWS+OQkX6z6Jy9TGROjtf9dnRlK7pkkMKMg/KVEmSNCLTyl7+aKxBbZOFIJQWp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.978.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.978.0/index.min.mjs": "sha384-gmlWS+OQkX6z6Jy9TGROjtf9dnRlK7pkkMKMg/KVEmSNCLTyl7+aKxBbZOFIJQWp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.978.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.556.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.556.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ewHIo2+QkMFjisU7xHMmQ5e1ppep9FT9wf45Ys7kB8MVQen9XgsTMw3QYIQHR649
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.556.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.556.0/index.min.mjs": "sha384-ewHIo2+QkMFjisU7xHMmQ5e1ppep9FT9wf45Ys7kB8MVQen9XgsTMw3QYIQHR649"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.556.0/LICENSE
```

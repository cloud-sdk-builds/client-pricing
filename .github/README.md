...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.967.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.967.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rDaylTpkOq/7lUY98IP3FxNv+vlLOOCpUOxm0JkskDAeoY+8sSZkKNTJC7hfZiOm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.967.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.967.0/index.min.mjs": "sha384-rDaylTpkOq/7lUY98IP3FxNv+vlLOOCpUOxm0JkskDAeoY+8sSZkKNTJC7hfZiOm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.967.0/LICENSE
```

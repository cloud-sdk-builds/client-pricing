...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.621.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.621.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vWnbW7iwf4b9VDxaiJ0+qQiESQj2nW7emtP5uCplfRFmf5z21fTryzfu/LjEKSxJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.621.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.621.0/index.min.mjs": "sha384-vWnbW7iwf4b9VDxaiJ0+qQiESQj2nW7emtP5uCplfRFmf5z21fTryzfu/LjEKSxJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.621.0/LICENSE
```

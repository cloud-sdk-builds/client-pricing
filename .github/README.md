...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.991.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.991.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SvDG9IP+s5UkXHhuJjIXVTavruI/smPio9smxP9BQHiVQ6M+n0+lgjeJs3h/V1Zp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.991.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.991.0/index.min.mjs": "sha384-SvDG9IP+s5UkXHhuJjIXVTavruI/smPio9smxP9BQHiVQ6M+n0+lgjeJs3h/V1Zp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.991.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.565.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.565.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5QHg4IU10IfgnlIccPDnzu0UwhUMfCRxRSqThsHxxunaLEm04l3a9OH8rDQlx37o
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.565.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.565.0/index.min.mjs": "sha384-5QHg4IU10IfgnlIccPDnzu0UwhUMfCRxRSqThsHxxunaLEm04l3a9OH8rDQlx37o"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.565.0/LICENSE
```

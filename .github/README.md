...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.926.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.926.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-B5xCdMqMjzuk+6p4CDxnHxLsev0EMFH0nSM1Bj9RgTwd4NKPTLQqPkYOuF15UMpO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.926.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.926.0/index.min.mjs": "sha384-B5xCdMqMjzuk+6p4CDxnHxLsev0EMFH0nSM1Bj9RgTwd4NKPTLQqPkYOuF15UMpO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.926.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.142.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.142.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-E4eLvLntbUtSE2Ef08VPEIckbyUMPnQl/ua/LeE8Hcfblgb+JRU+LkGQDNmIu0M9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.142.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.142.0/index.min.mjs": "sha384-E4eLvLntbUtSE2Ef08VPEIckbyUMPnQl/ua/LeE8Hcfblgb+JRU+LkGQDNmIu0M9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.142.0/LICENSE
```

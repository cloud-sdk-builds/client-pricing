...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.6.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.6.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-oN8FUUzN0qh2NzbxjyWAsx455RSB+ebIOagvKa6fc9HRltP5Pjfu5GkUcVVIPhUG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.6.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.6.1/index.min.mjs": "sha384-oN8FUUzN0qh2NzbxjyWAsx455RSB+ebIOagvKa6fc9HRltP5Pjfu5GkUcVVIPhUG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.6.1/LICENSE
```

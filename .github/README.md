...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.667.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.667.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3LMnjwBDbv70clP2B/QOI/kYWUHpIb8t04GnHFx8+xQFDEQmPyj6IZV4t7vdblc1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.667.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.667.0/index.min.mjs": "sha384-3LMnjwBDbv70clP2B/QOI/kYWUHpIb8t04GnHFx8+xQFDEQmPyj6IZV4t7vdblc1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.667.0/LICENSE
```

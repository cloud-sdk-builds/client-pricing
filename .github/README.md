...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.347.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.347.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p0QYPFToZkd5Pv8uKHFS830FewkT+3Y2gv2cU6RwpytD4fSdhewnB5eYhxhOG6Gh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.347.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.347.0/index.min.mjs": "sha384-p0QYPFToZkd5Pv8uKHFS830FewkT+3Y2gv2cU6RwpytD4fSdhewnB5eYhxhOG6Gh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.347.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.382.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.382.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JnX4BcGK5GhKUjJsxDomvS8kYzu8W4Y+nNyspWr9LqJqV++Dq0i5/dX+ylsbCEY+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.382.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.382.0/index.min.mjs": "sha384-JnX4BcGK5GhKUjJsxDomvS8kYzu8W4Y+nNyspWr9LqJqV++Dq0i5/dX+ylsbCEY+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.382.0/LICENSE
```

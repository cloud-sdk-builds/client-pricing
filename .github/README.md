...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.161.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.161.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ca60S7nh1Tylg0jGxJwKMnZGhXhUOeJ99ETOuw5shUjqPgILMEAum8HtGtJxlwMU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.161.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.161.0/index.min.mjs": "sha384-Ca60S7nh1Tylg0jGxJwKMnZGhXhUOeJ99ETOuw5shUjqPgILMEAum8HtGtJxlwMU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.161.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.75.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.75.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-77tdSAIhtqrDPKSTlQulX/aFj3leUAn+oo/rk4ZL1QPQiyiLG/cugdLGsAbR5COs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.75.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.75.0/index.min.mjs": "sha384-77tdSAIhtqrDPKSTlQulX/aFj3leUAn+oo/rk4ZL1QPQiyiLG/cugdLGsAbR5COs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.75.0/LICENSE
```

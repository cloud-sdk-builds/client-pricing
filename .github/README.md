...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.461.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.461.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AHxenn+EZnZbd1aE08RDq3R6h+5k4fMY1hghIHVuO4OegMG8IPxdpfIF7REDBUkZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.461.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.461.0/index.min.mjs": "sha384-AHxenn+EZnZbd1aE08RDq3R6h+5k4fMY1hghIHVuO4OegMG8IPxdpfIF7REDBUkZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.461.0/LICENSE
```

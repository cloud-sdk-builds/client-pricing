...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.276.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.276.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ijn8FD1hfIbn9sH+5RiI3vxbHS3MEdylwuNU8JdVjuOfjClIQVgEDVx8K44ColZP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.276.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.276.0/index.min.mjs": "sha384-ijn8FD1hfIbn9sH+5RiI3vxbHS3MEdylwuNU8JdVjuOfjClIQVgEDVx8K44ColZP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.276.0/LICENSE
```

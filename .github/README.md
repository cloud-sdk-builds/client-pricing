...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.476.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.476.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-h7vXbbwJwM/6yMRRbTHXYx6UcRbtMXleYdrRQKP3n3Ed2AlHjbLlX4XWbi5B2ZND
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.476.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.476.0/index.min.mjs": "sha384-h7vXbbwJwM/6yMRRbTHXYx6UcRbtMXleYdrRQKP3n3Ed2AlHjbLlX4XWbi5B2ZND"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.476.0/LICENSE
```

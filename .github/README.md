...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.716.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.716.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bOZ75p46402urOzGhsY1+LOk5dcohId+92PkJ9DUf4dl6d1sY8mkFKoCqhqj1zaT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.716.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.716.0/index.min.mjs": "sha384-bOZ75p46402urOzGhsY1+LOk5dcohId+92PkJ9DUf4dl6d1sY8mkFKoCqhqj1zaT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.716.0/LICENSE
```

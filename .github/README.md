...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.622.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.622.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-omJ8+6a1xAzGP2U09i9r8BjVKc0oz5vnfZPg8Bloz4u0KFrGB4raVOoqmHGuHLP/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.622.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.622.0/index.min.mjs": "sha384-omJ8+6a1xAzGP2U09i9r8BjVKc0oz5vnfZPg8Bloz4u0KFrGB4raVOoqmHGuHLP/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.622.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.503.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.503.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lrd4VsiqEo/Rdslcj9qAxkf28DOANgUgB4yLtZQiT+/W25kXqnh4BfaXjrxHb0H5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.503.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.503.0/index.min.mjs": "sha384-lrd4VsiqEo/Rdslcj9qAxkf28DOANgUgB4yLtZQiT+/W25kXqnh4BfaXjrxHb0H5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.503.0/LICENSE
```

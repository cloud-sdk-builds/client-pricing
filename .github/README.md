...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.955.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.955.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GL6ddipjztwvXXwsiB7ka/xPJhAC7TYEkiHa+zmKbIEVvV5dYLViJ19VzoFIDox/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.955.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.955.0/index.min.mjs": "sha384-GL6ddipjztwvXXwsiB7ka/xPJhAC7TYEkiHa+zmKbIEVvV5dYLViJ19VzoFIDox/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.955.0/LICENSE
```

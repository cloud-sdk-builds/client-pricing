...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.5.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.5.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-m6pIZ9GynLUeWF5IJl8KrX503ClYUGIuo1xf5ZO3TC7HWvodnGHARuhm9tRXthKX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.5.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.5.0/index.min.mjs": "sha384-m6pIZ9GynLUeWF5IJl8KrX503ClYUGIuo1xf5ZO3TC7HWvodnGHARuhm9tRXthKX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.5.0/LICENSE
```

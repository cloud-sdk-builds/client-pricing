...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.431.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.431.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tFTvDuRuy3IyhF8Lpvm/XbHP6cfVudq2d8lqjlpWbzH+/7EVyCnjwmkywz0YhI8L
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.431.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.431.0/index.min.mjs": "sha384-tFTvDuRuy3IyhF8Lpvm/XbHP6cfVudq2d8lqjlpWbzH+/7EVyCnjwmkywz0YhI8L"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.431.0/LICENSE
```

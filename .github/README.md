...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.917.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.917.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JQBbc3rk4o+UHYVwAusr3DvaAvaUmeFhItZY+tfmmXoiU7xFqrmmOECwlQvYkeqz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.917.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.917.0/index.min.mjs": "sha384-JQBbc3rk4o+UHYVwAusr3DvaAvaUmeFhItZY+tfmmXoiU7xFqrmmOECwlQvYkeqz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.917.0/LICENSE
```

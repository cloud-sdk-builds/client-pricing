...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.435.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.435.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0ZpT8gAwIJ5gqW8jYDB08ET6AW4itMoJOHgF1vw12AFg0RIvTCVtC9wowiWaFNuJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.435.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.435.0/index.min.mjs": "sha384-0ZpT8gAwIJ5gqW8jYDB08ET6AW4itMoJOHgF1vw12AFg0RIvTCVtC9wowiWaFNuJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.435.0/LICENSE
```

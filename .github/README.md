...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.170.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.170.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wNhcR0HbmHzDLZPFE2bQrSjAsej5x9FqooSszI9uuVLkVo2wwn+VKho+WikWXwFb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.170.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.170.0/index.min.mjs": "sha384-wNhcR0HbmHzDLZPFE2bQrSjAsej5x9FqooSszI9uuVLkVo2wwn+VKho+WikWXwFb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.170.0/LICENSE
```

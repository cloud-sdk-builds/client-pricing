...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.458.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.458.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-A9ohRJeAf0uCVMCdMxqpWiWa8DPG/98dUvreIOKDANP/0LV1EXPaW7UYvgxgQYVY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.458.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.458.0/index.min.mjs": "sha384-A9ohRJeAf0uCVMCdMxqpWiWa8DPG/98dUvreIOKDANP/0LV1EXPaW7UYvgxgQYVY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.458.0/LICENSE
```

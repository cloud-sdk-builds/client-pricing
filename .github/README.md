...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.223.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.223.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-F5AMBB6fxmXaA244A4F9DI+jWsHtWNfFcnK5mIuuibFruXG5U+awXp89tFEcPL0/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.223.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.223.0/index.min.mjs": "sha384-F5AMBB6fxmXaA244A4F9DI+jWsHtWNfFcnK5mIuuibFruXG5U+awXp89tFEcPL0/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.223.0/LICENSE
```

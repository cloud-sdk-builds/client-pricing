...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.238.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.238.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zZhyc0+vK2U/JxN6haGq1z7auwwCKs8nwTlQSvasGjcu8SsMBo7AgA95FQtFpeYj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.238.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.238.0/index.min.mjs": "sha384-zZhyc0+vK2U/JxN6haGq1z7auwwCKs8nwTlQSvasGjcu8SsMBo7AgA95FQtFpeYj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.238.0/LICENSE
```

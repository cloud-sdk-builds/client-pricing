...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.587.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.587.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zODRArFtTd0sjV6PbwpBr3SD2Rz5hUFVoM5Gs6fHFb7MDEJ3VHIy7R+US/lOm1ld
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.587.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.587.0/index.min.mjs": "sha384-zODRArFtTd0sjV6PbwpBr3SD2Rz5hUFVoM5Gs6fHFb7MDEJ3VHIy7R+US/lOm1ld"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.587.0/LICENSE
```

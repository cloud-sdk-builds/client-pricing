...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.281.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.281.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AWwkyc2tyGqF5b3c6ABKY/LvS0IMBnkZNoOlNGXj+ohkruXfuQjDGl76eeAgbeR7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.281.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.281.0/index.min.mjs": "sha384-AWwkyc2tyGqF5b3c6ABKY/LvS0IMBnkZNoOlNGXj+ohkruXfuQjDGl76eeAgbeR7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.281.0/LICENSE
```

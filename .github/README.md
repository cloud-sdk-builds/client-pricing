...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.925.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.925.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GyEuaP2dcw3tui+Nw8w0ODsyh0RCP11agOBJHVmjotPCyogJqEbNZnBk71r1Oeyn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.925.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.925.0/index.min.mjs": "sha384-GyEuaP2dcw3tui+Nw8w0ODsyh0RCP11agOBJHVmjotPCyogJqEbNZnBk71r1Oeyn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.925.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.576.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.576.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-E3bfkNAoEQb6CCNJCUuD63Lj1RWyRlXVFEmfpY0l5G3vvUzydA1RiqSUqUpk4b2e
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.576.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.576.0/index.min.mjs": "sha384-E3bfkNAoEQb6CCNJCUuD63Lj1RWyRlXVFEmfpY0l5G3vvUzydA1RiqSUqUpk4b2e"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.576.0/LICENSE
```

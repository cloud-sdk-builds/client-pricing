...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.485.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.485.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5PMIwbAyQyGL27T+LCqmnVqBFtiNYgQm7HbJ/CboCR2hwvAcU/Z7OdEUVGzzyD58
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.485.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.485.0/index.min.mjs": "sha384-5PMIwbAyQyGL27T+LCqmnVqBFtiNYgQm7HbJ/CboCR2hwvAcU/Z7OdEUVGzzyD58"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.485.0/LICENSE
```

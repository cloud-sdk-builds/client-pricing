...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.292.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.292.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p7SyUreE6xaXKnBcnqsFWT7LMfGjueFJEYQzT0IrYHwTtm836vm3S03iUjaTp1AK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.292.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.292.0/index.min.mjs": "sha384-p7SyUreE6xaXKnBcnqsFWT7LMfGjueFJEYQzT0IrYHwTtm836vm3S03iUjaTp1AK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.292.0/LICENSE
```

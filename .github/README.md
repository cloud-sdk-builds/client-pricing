...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.118.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.118.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nyMRjGV5RQcpYk3wIkewaof967Ktw1R1O1KJUHDj/sOqJVwW6HxfhUsnddbnprqt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.118.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.118.0/index.min.mjs": "sha384-nyMRjGV5RQcpYk3wIkewaof967Ktw1R1O1KJUHDj/sOqJVwW6HxfhUsnddbnprqt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.118.0/LICENSE
```

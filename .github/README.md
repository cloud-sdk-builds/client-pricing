...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.856.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.856.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HXErD/NJfqIfRd7rh5GvKrAdf79y2mfplTfOSTg9VLT/DroFABTjJjrjNfJcCZqK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.856.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.856.0/index.min.mjs": "sha384-HXErD/NJfqIfRd7rh5GvKrAdf79y2mfplTfOSTg9VLT/DroFABTjJjrjNfJcCZqK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.856.0/LICENSE
```

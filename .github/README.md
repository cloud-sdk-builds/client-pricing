...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.564.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.564.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-s3VNA+B7YHGLwi+XQpTz9Xsnbap3EIbxKtcqYxsy+jtOFQvX9xCBxRA2cqR+4KjP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.564.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.564.0/index.min.mjs": "sha384-s3VNA+B7YHGLwi+XQpTz9Xsnbap3EIbxKtcqYxsy+jtOFQvX9xCBxRA2cqR+4KjP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.564.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.49.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.49.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NJizpNDRuvWrY8u/4X3tZhQnWfMa//r+0ipFzBhGSEmfjm8xro+XmWvwcMP3lz2s
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.49.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.49.0/index.min.mjs": "sha384-NJizpNDRuvWrY8u/4X3tZhQnWfMa//r+0ipFzBhGSEmfjm8xro+XmWvwcMP3lz2s"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.49.0/LICENSE
```

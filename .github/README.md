...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.35.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.35.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2CKDXzpVgoaT1gGdh7LmUDI3BWhRhZms+FscR4ldO3XHyD39Qu0UP6Q2I5CLIUCN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.35.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.35.0/index.min.mjs": "sha384-2CKDXzpVgoaT1gGdh7LmUDI3BWhRhZms+FscR4ldO3XHyD39Qu0UP6Q2I5CLIUCN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.35.0/LICENSE
```

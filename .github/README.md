...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.1038.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1038.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BthLU7Irt/2z7CEUKmqIIey/Y15xgdunKR9zIuCu311pDTqxrVE4nMJFiXo/RoDa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1038.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1038.0/index.min.mjs": "sha384-BthLU7Irt/2z7CEUKmqIIey/Y15xgdunKR9zIuCu311pDTqxrVE4nMJFiXo/RoDa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.1038.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.744.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.744.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-L5B7MupRw5WlYhhcvSPRVjS1FuQQMQu17Y3Y1ih0IgtKxMYowwDOWJ8VjUPtUSrX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.744.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.744.0/index.min.mjs": "sha384-L5B7MupRw5WlYhhcvSPRVjS1FuQQMQu17Y3Y1ih0IgtKxMYowwDOWJ8VjUPtUSrX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.744.0/LICENSE
```

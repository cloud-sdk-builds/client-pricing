...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.209.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.209.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GpVv6zWtTJXLTHfBofoUrmrdUPdTTQenoXn8h9ATULijejkfPfa8eGc8LJRloB+h
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.209.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.209.0/index.min.mjs": "sha384-GpVv6zWtTJXLTHfBofoUrmrdUPdTTQenoXn8h9ATULijejkfPfa8eGc8LJRloB+h"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.209.0/LICENSE
```

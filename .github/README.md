...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.222.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.222.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DDyd5hYZd/E43Bsu58EbhX3NOtyzIGJJ+3yPniUzGMqmvRNPIrIWRR3C69I52NBO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.222.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.222.0/index.min.mjs": "sha384-DDyd5hYZd/E43Bsu58EbhX3NOtyzIGJJ+3yPniUzGMqmvRNPIrIWRR3C69I52NBO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.222.0/LICENSE
```

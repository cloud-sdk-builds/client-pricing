...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.734.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.734.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CpYkmn9AFWyAyzTTT8JM6swa2aZtLW52hpYjvjbeqdIY+wcVYXkpGamsC3Qh+MxK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.734.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.734.0/index.min.mjs": "sha384-CpYkmn9AFWyAyzTTT8JM6swa2aZtLW52hpYjvjbeqdIY+wcVYXkpGamsC3Qh+MxK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.734.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.85.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.85.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZIVDLcq2o5jTCwk/NbDWp66GX4dWJSaArA8kLGytMC3E4KgGXaMWz7j7j+fs9yjR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.85.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.85.0/index.min.mjs": "sha384-ZIVDLcq2o5jTCwk/NbDWp66GX4dWJSaArA8kLGytMC3E4KgGXaMWz7j7j+fs9yjR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.85.0/LICENSE
```

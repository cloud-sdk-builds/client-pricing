...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.16.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.16.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-J+G2gbDZPHKg0+Q6onSxDSjm9DW/iKVeWl36EXOA/anKd6PWSJDYmUZyT75UYsgd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.16.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.16.0/index.min.mjs": "sha384-J+G2gbDZPHKg0+Q6onSxDSjm9DW/iKVeWl36EXOA/anKd6PWSJDYmUZyT75UYsgd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.16.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.964.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.964.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-URU1NncJ3mcv6coVp6LAKdb6zSm0/O+LhsDiihlSNMPseEidJfLE170HG1REIq/S
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.964.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.964.0/index.min.mjs": "sha384-URU1NncJ3mcv6coVp6LAKdb6zSm0/O+LhsDiihlSNMPseEidJfLE170HG1REIq/S"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.964.0/LICENSE
```

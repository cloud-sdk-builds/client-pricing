...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.162.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.162.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vXwwf01CnY1Nq3Fnatx820ZTJe/NPVxHVge0Z//iWdGS1GR3xgPUS1ouKhED+kR+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.162.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.162.0/index.min.mjs": "sha384-vXwwf01CnY1Nq3Fnatx820ZTJe/NPVxHVge0Z//iWdGS1GR3xgPUS1ouKhED+kR+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.162.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.825.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.825.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BKxLIw4RDGfFR8YtY4UgkG8YqhJ6xeu7gr0RafESfoBrjH6DeJgn9V9+c5lrSSPA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.825.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.825.0/index.min.mjs": "sha384-BKxLIw4RDGfFR8YtY4UgkG8YqhJ6xeu7gr0RafESfoBrjH6DeJgn9V9+c5lrSSPA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.825.0/LICENSE
```

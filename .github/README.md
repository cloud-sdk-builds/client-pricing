...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.449.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.449.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-h+w6HPc1WctTC7nhxdGXOoEiRPqGEN+uNLk9V6cDkr2b+DYkA5ztTd8F6GXS/K4A
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.449.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.449.0/index.min.mjs": "sha384-h+w6HPc1WctTC7nhxdGXOoEiRPqGEN+uNLk9V6cDkr2b+DYkA5ztTd8F6GXS/K4A"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.449.0/LICENSE
```

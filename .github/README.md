...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.295.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.295.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UmeaavKAVipplQc0YhQBn0V9XJwDG4S92sHliOuTxhe5B5aiDMymoPlLVWxa3Zzf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.295.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.295.0/index.min.mjs": "sha384-UmeaavKAVipplQc0YhQBn0V9XJwDG4S92sHliOuTxhe5B5aiDMymoPlLVWxa3Zzf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.295.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.985.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.985.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-w7PTOT4v4ojQyzallszhOlBUB5PjI03aLUcZWySQeVHPx1nKfjVnKmkM9J2/hVkh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.985.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.985.0/index.min.mjs": "sha384-w7PTOT4v4ojQyzallszhOlBUB5PjI03aLUcZWySQeVHPx1nKfjVnKmkM9J2/hVkh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.985.0/LICENSE
```

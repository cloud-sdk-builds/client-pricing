...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.952.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.952.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/idcYIC07sTh0IR2GSEE6RZtqCHejA4fKW2xLSXLS0FVZ0UaUfcDElJsXA4cXtNM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.952.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.952.0/index.min.mjs": "sha384-/idcYIC07sTh0IR2GSEE6RZtqCHejA4fKW2xLSXLS0FVZ0UaUfcDElJsXA4cXtNM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.952.0/LICENSE
```

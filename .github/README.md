...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.13.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.13.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-I4mJAx+m4+DyB/lgckMTLbfpj7tPMCmb0xt2DdJQP1lszOEgmlP7jRxqFAd1DmOM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.13.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.13.0/index.min.mjs": "sha384-I4mJAx+m4+DyB/lgckMTLbfpj7tPMCmb0xt2DdJQP1lszOEgmlP7jRxqFAd1DmOM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.13.0/LICENSE
```

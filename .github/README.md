...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.846.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.846.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-krreYEOxBu03kukcDMeqzxl0u4nps4hojeUVzU2nAPLDrj8OogxpuUhxGeBFEefy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.846.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.846.0/index.min.mjs": "sha384-krreYEOxBu03kukcDMeqzxl0u4nps4hojeUVzU2nAPLDrj8OogxpuUhxGeBFEefy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.846.0/LICENSE
```

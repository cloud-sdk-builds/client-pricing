...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.496.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.496.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UDvr1/nO9KN6ORSUnvfQ0nMwjrtfkWzGp1bhW1AZXYuLFpm1TUjkfAxbnfzX+1pa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.496.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.496.0/index.min.mjs": "sha384-UDvr1/nO9KN6ORSUnvfQ0nMwjrtfkWzGp1bhW1AZXYuLFpm1TUjkfAxbnfzX+1pa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.496.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.665.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.665.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3tDZbMkRazoH2hhZrHS9T6rsVwS8TiY5ZlnEyxZTWd586ZfVN/SS5358PsauTfM4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.665.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.665.0/index.min.mjs": "sha384-3tDZbMkRazoH2hhZrHS9T6rsVwS8TiY5ZlnEyxZTWd586ZfVN/SS5358PsauTfM4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.665.0/LICENSE
```

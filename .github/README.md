...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.946.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.946.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/do/pTmb5lXijX5RBLwxX+wdbesM6a5DkDln/oZ/Rj9qmS/F33JcyHWZELmHRZF0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.946.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.946.0/index.min.mjs": "sha384-/do/pTmb5lXijX5RBLwxX+wdbesM6a5DkDln/oZ/Rj9qmS/F33JcyHWZELmHRZF0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.946.0/LICENSE
```

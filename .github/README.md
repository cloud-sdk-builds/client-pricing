...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.279.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.279.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wWAatvqsXbi6jV4884JILSr8HqjMsRL5QCOPLC6psVS/sipUUwtfTA1RZmw1A/ny
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.279.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.279.0/index.min.mjs": "sha384-wWAatvqsXbi6jV4884JILSr8HqjMsRL5QCOPLC6psVS/sipUUwtfTA1RZmw1A/ny"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.279.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.828.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.828.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CbCSXQkysDvNxP9IzrAsn1BYF38OSkWbcM0zOYXQpS/47KHB/u4c6BTLgjfa4SN6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.828.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.828.0/index.min.mjs": "sha384-CbCSXQkysDvNxP9IzrAsn1BYF38OSkWbcM0zOYXQpS/47KHB/u4c6BTLgjfa4SN6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.828.0/LICENSE
```

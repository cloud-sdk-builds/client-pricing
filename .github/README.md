...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.600.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.600.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-r2X89LZs/IoC97gI1fE12FnnlcU7x9lbzBVjMpXPDARglfH6LvYjtdrWk86Xbqz5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.600.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.600.0/index.min.mjs": "sha384-r2X89LZs/IoC97gI1fE12FnnlcU7x9lbzBVjMpXPDARglfH6LvYjtdrWk86Xbqz5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.600.0/LICENSE
```

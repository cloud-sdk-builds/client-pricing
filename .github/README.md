...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.473.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.473.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CILHPTMf6FiXqkkty11x6x7oTLEzV2fLLjFOmjRpIfDeQlfZMLiK162dJg66uTJs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.473.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.473.0/index.min.mjs": "sha384-CILHPTMf6FiXqkkty11x6x7oTLEzV2fLLjFOmjRpIfDeQlfZMLiK162dJg66uTJs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.473.0/LICENSE
```

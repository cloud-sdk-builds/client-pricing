...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.41.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.41.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BU+1MlPRHH115XQZw/qtoutzeHf4YmnMHEzULCnn4nBoIRR5m5ABr16Dt78sA+EH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.41.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.41.0/index.min.mjs": "sha384-BU+1MlPRHH115XQZw/qtoutzeHf4YmnMHEzULCnn4nBoIRR5m5ABr16Dt78sA+EH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.41.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.863.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.863.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Qkars6erkQ+MLSC6az+HeY4AcCGQnggtJygtdd3fc/n4i1/K4K99Bj0hBxqSuS0h
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.863.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.863.0/index.min.mjs": "sha384-Qkars6erkQ+MLSC6az+HeY4AcCGQnggtJygtdd3fc/n4i1/K4K99Bj0hBxqSuS0h"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.863.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.796.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.796.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LBK19zZNndGq3tnLGhYJFBmQyG/YXdzwBpBlGD373s5TPe2q8+0lq1W3Pc0yqdWg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.796.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.796.0/index.min.mjs": "sha384-LBK19zZNndGq3tnLGhYJFBmQyG/YXdzwBpBlGD373s5TPe2q8+0lq1W3Pc0yqdWg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.796.0/LICENSE
```

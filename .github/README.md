...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.76.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.76.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aJLkaRoJtdQ6z6wG9SOcEHKTQNTeR1qdro2P0tzfTOVgt5a1+maCnWUi1/DZjp5I
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.76.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.76.0/index.min.mjs": "sha384-aJLkaRoJtdQ6z6wG9SOcEHKTQNTeR1qdro2P0tzfTOVgt5a1+maCnWUi1/DZjp5I"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.76.0/LICENSE
```

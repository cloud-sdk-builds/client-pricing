...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.1027.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1027.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-58MkEGz2DGzfVKFHBdTTGLtIUp+8HHiicchlmjyx5lKi9WENwt6zpL/ZTqAVD3Fr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1027.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1027.0/index.min.mjs": "sha384-58MkEGz2DGzfVKFHBdTTGLtIUp+8HHiicchlmjyx5lKi9WENwt6zpL/ZTqAVD3Fr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.1027.0/LICENSE
```

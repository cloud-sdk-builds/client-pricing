...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.192.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.192.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RR8EE7F8osXigr6pKNBf8JfPymGDlUdjAb/b7ziwEygJX75u7/rhIj5JHqXWJSwM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.192.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.192.0/index.min.mjs": "sha384-RR8EE7F8osXigr6pKNBf8JfPymGDlUdjAb/b7ziwEygJX75u7/rhIj5JHqXWJSwM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.192.0/LICENSE
```

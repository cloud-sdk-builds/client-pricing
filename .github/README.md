...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.329.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.329.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-30KiIOe3sNn/JANJvhbrkTZUZdO1hwNG3pYHNNA/mfslVq7pPZumevVdCsOXX+Af
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.329.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.329.0/index.min.mjs": "sha384-30KiIOe3sNn/JANJvhbrkTZUZdO1hwNG3pYHNNA/mfslVq7pPZumevVdCsOXX+Af"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.329.0/LICENSE
```

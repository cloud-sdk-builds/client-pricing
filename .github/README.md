...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.504.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.504.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/fGqy0rOURSDrxi3iNqP9TLvouM3lAuE9pVAHoTpwEgI8b9uULHHHdJBbGinVpik
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.504.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.504.0/index.min.mjs": "sha384-/fGqy0rOURSDrxi3iNqP9TLvouM3lAuE9pVAHoTpwEgI8b9uULHHHdJBbGinVpik"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.504.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.858.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.858.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kG3unHxhzcc1hOnUOWCQuxppyU9+lyQ1Vgw8vbIEXspF91T0dRimlQ+kclx72N/9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.858.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.858.0/index.min.mjs": "sha384-kG3unHxhzcc1hOnUOWCQuxppyU9+lyQ1Vgw8vbIEXspF91T0dRimlQ+kclx72N/9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.858.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.8.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.8.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8xgOTmI6bPTC1PzDTYC2WTb5/ZstPqHGG8TcCbOsHCT663qH9kS2Ye/RhrGNdRU4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.8.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.8.0/index.min.mjs": "sha384-8xgOTmI6bPTC1PzDTYC2WTb5/ZstPqHGG8TcCbOsHCT663qH9kS2Ye/RhrGNdRU4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.8.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.112.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.112.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oAF9ydEr1ABkGlgfmVoUzNxSiIgZIG1a5kiQ10/FHpGlXYDH5aoHfbov4Ynuvurq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.112.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.112.0/index.min.mjs": "sha384-oAF9ydEr1ABkGlgfmVoUzNxSiIgZIG1a5kiQ10/FHpGlXYDH5aoHfbov4Ynuvurq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.112.0/LICENSE
```

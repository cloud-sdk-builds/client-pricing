...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.299.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.299.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ig5xEICiXqv0eGdfEt2NFSSrbHf3Ilw1Rfi3DfLC+u/+KYkJAzVfGNf3tYXQ0dIK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.299.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.299.0/index.min.mjs": "sha384-ig5xEICiXqv0eGdfEt2NFSSrbHf3Ilw1Rfi3DfLC+u/+KYkJAzVfGNf3tYXQ0dIK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.299.0/LICENSE
```

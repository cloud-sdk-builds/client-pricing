...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.398.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.398.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jfIytSIOCgrFre22bQw17SrDf3T358C+phRuIiycno8hDonY2SXt/vX1L/GJzIsG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.398.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.398.0/index.min.mjs": "sha384-jfIytSIOCgrFre22bQw17SrDf3T358C+phRuIiycno8hDonY2SXt/vX1L/GJzIsG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.398.0/LICENSE
```

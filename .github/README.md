...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.127.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.127.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0XsGTAaCdtug0E8HUUTAyC9vjiW8XwO3NUitOzJ8L27MRb9JsVxKs2qpIemVM7jH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.127.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.127.0/index.min.mjs": "sha384-0XsGTAaCdtug0E8HUUTAyC9vjiW8XwO3NUitOzJ8L27MRb9JsVxKs2qpIemVM7jH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.127.0/LICENSE
```

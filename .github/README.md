...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.986.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.986.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WNH1V1/oxnMVRh3rCLZmINOOEeaYRpvKt8sbr7rdkXR8EQ+ePuBel/gohY9Qu/92
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.986.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.986.0/index.min.mjs": "sha384-WNH1V1/oxnMVRh3rCLZmINOOEeaYRpvKt8sbr7rdkXR8EQ+ePuBel/gohY9Qu/92"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.986.0/LICENSE
```

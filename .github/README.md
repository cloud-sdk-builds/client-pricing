...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.181.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.181.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-J+CYuTBUiRaVpxTV0/Uvk21Jk6nTO6kl0/K1tJ7tmfDSfOr6n57euhysx/4YVUoz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.181.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.181.0/index.min.mjs": "sha384-J+CYuTBUiRaVpxTV0/Uvk21Jk6nTO6kl0/K1tJ7tmfDSfOr6n57euhysx/4YVUoz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.181.0/LICENSE
```

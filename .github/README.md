...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.1000.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1000.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Hn5Txu48tRH+jvhD9LswZ2dqY+XHbDhMvcuOfMgg4EBxhMwhlHc7xj3/9QQfYMGE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1000.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1000.0/index.min.mjs": "sha384-Hn5Txu48tRH+jvhD9LswZ2dqY+XHbDhMvcuOfMgg4EBxhMwhlHc7xj3/9QQfYMGE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.1000.0/LICENSE
```

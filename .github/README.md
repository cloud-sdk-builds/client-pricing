...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.484.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.484.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TpraIN89j3uP9FClqOT36NXZn+fi2Y7riX5oflTcf3XUyRlgv4rMZtuk/e5FPt9O
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.484.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.484.0/index.min.mjs": "sha384-TpraIN89j3uP9FClqOT36NXZn+fi2Y7riX5oflTcf3XUyRlgv4rMZtuk/e5FPt9O"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.484.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.94.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.94.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ez+AcggkGbxp7gRF3mnJYmbF2Gt/MI4Luk5V5shkGrxh3Hty4PscxllDHbYn8NbH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.94.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.94.0/index.min.mjs": "sha384-ez+AcggkGbxp7gRF3mnJYmbF2Gt/MI4Luk5V5shkGrxh3Hty4PscxllDHbYn8NbH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.94.0/LICENSE
```

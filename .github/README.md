...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.675.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.675.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XZcShD29DLVsyWG5sFYs5hGI1SlZbccnAfJkJArnYjOQZLjtVsX/PmIHDLDe/pi6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.675.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.675.0/index.min.mjs": "sha384-XZcShD29DLVsyWG5sFYs5hGI1SlZbccnAfJkJArnYjOQZLjtVsX/PmIHDLDe/pi6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.675.0/LICENSE
```

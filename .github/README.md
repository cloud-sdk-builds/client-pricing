...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.7.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.7.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-X+ruL4lTKejsbSzW8Ce6Z2RuxOOnu9JtpvUv82an0X1LhWMBWGxCZqmT6CXO8Ujj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.7.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.7.0/index.min.mjs": "sha384-X+ruL4lTKejsbSzW8Ce6Z2RuxOOnu9JtpvUv82an0X1LhWMBWGxCZqmT6CXO8Ujj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.7.0/LICENSE
```

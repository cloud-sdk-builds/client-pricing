...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.258.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.258.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sk3HE7EGyDjJBsF+twVCLGbmD82t8Kfk6jsEj0gHHM3BjO8zS6a/KhMnPBVo4Eui
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.258.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.258.0/index.min.mjs": "sha384-sk3HE7EGyDjJBsF+twVCLGbmD82t8Kfk6jsEj0gHHM3BjO8zS6a/KhMnPBVo4Eui"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.258.0/LICENSE
```

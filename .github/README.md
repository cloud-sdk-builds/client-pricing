...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.966.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.966.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-R57HqLWtxGDxqrtHyOXTeZeUrcbbG4JCaVjiLvg93/Sm65l+/76r65f1EIowLv+O
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.966.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.966.0/index.min.mjs": "sha384-R57HqLWtxGDxqrtHyOXTeZeUrcbbG4JCaVjiLvg93/Sm65l+/76r65f1EIowLv+O"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.966.0/LICENSE
```

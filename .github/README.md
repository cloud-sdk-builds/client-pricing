...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.28.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.28.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7S10KqlmjeRrC9f2TfSEOWyBryGybpepTUYbGMEYgb2Xi+3Au3SLDyt3EJCipy3V
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.28.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.28.0/index.min.mjs": "sha384-7S10KqlmjeRrC9f2TfSEOWyBryGybpepTUYbGMEYgb2Xi+3Au3SLDyt3EJCipy3V"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.28.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.797.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.797.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pab2hD9y3c+s7SE/9VxKT6VLmCVYhF0J9MXB7CMyhsKqmZCPhR0k5nVtb0SnhiBn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.797.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.797.0/index.min.mjs": "sha384-pab2hD9y3c+s7SE/9VxKT6VLmCVYhF0J9MXB7CMyhsKqmZCPhR0k5nVtb0SnhiBn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.797.0/LICENSE
```

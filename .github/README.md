...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.312.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.312.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Et26FH4ArVneysjwju6IJ0dh1uJ8DjX2AhZK4bPvm/85gViPtxiWVC0+2xppYZyf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.312.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.312.0/index.min.mjs": "sha384-Et26FH4ArVneysjwju6IJ0dh1uJ8DjX2AhZK4bPvm/85gViPtxiWVC0+2xppYZyf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.312.0/LICENSE
```

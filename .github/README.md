...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.906.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.906.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-c2e9ByOz9pnuyZ2ID20A95VleiDICoNXuKRThhrfsN/amacUI2RKRA3o4Sez4/uj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.906.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.906.0/index.min.mjs": "sha384-c2e9ByOz9pnuyZ2ID20A95VleiDICoNXuKRThhrfsN/amacUI2RKRA3o4Sez4/uj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.906.0/LICENSE
```

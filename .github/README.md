...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.682.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.682.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-chyrO7DhMJN0eqrS0WMZ6qPwnZ2h+Mynqs61oGVxI5SvrWfSOLSRLbY+OSKbkVqp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.682.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.682.0/index.min.mjs": "sha384-chyrO7DhMJN0eqrS0WMZ6qPwnZ2h+Mynqs61oGVxI5SvrWfSOLSRLbY+OSKbkVqp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.682.0/LICENSE
```

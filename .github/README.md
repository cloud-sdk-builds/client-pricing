...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.890.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.890.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jNgkmtaWzTBlpV5k0U2UEfy3aR+174nDSl5rqK/2kDy3bRansPD55WptBysEBk3m
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.890.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.890.0/index.min.mjs": "sha384-jNgkmtaWzTBlpV5k0U2UEfy3aR+174nDSl5rqK/2kDy3bRansPD55WptBysEBk3m"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.890.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.436.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.436.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bAj3U/uoezxuiZ5WOM20qATi22+W2GmIBAqIMAdV4lSdq+9h6HkncEXXIgCqBtZP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.436.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.436.0/index.min.mjs": "sha384-bAj3U/uoezxuiZ5WOM20qATi22+W2GmIBAqIMAdV4lSdq+9h6HkncEXXIgCqBtZP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.436.0/LICENSE
```

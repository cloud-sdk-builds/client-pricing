...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.272.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.272.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zldVA3YyNObQJ7JyhdxOloXuxMJcBK4Syw6dp9jX4GOnR9rBPHlABFxWv/vWMSyQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.272.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.272.0/index.min.mjs": "sha384-zldVA3YyNObQJ7JyhdxOloXuxMJcBK4Syw6dp9jX4GOnR9rBPHlABFxWv/vWMSyQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.272.0/LICENSE
```

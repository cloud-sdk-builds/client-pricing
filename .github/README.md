...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.699.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.699.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GhgP2T31XAmJCHhao+BY5netd4/A00CyxvcrveRhNt4LE7EEq8dtADOhn/gpa6O7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.699.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.699.0/index.min.mjs": "sha384-GhgP2T31XAmJCHhao+BY5netd4/A00CyxvcrveRhNt4LE7EEq8dtADOhn/gpa6O7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.699.0/LICENSE
```

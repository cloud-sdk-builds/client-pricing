...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.821.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.821.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oCpK2QFu36xg83tF/p8ze1O/i/Brdb5t26tFoM3WKsTkTUTeAkoIpd/X1L4KtCHb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.821.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.821.0/index.min.mjs": "sha384-oCpK2QFu36xg83tF/p8ze1O/i/Brdb5t26tFoM3WKsTkTUTeAkoIpd/X1L4KtCHb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.821.0/LICENSE
```

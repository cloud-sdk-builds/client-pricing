...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.141.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.141.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Fz7Aq6yWLCOJfsBGLW3/8Cp2e6NcRC1BXEB2ECLn5M7C252s61/tAl7Bt4XRK5DV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.141.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.141.0/index.min.mjs": "sha384-Fz7Aq6yWLCOJfsBGLW3/8Cp2e6NcRC1BXEB2ECLn5M7C252s61/tAl7Bt4XRK5DV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.141.0/LICENSE
```

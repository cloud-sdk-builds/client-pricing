...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.758.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.758.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yhF4vBgfCoNLaOnx4e6MDGHg1XWd1D8cUZ7rxp/S9NI2KvWb4F18tPfH6h/2/Kjz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.758.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.758.0/index.min.mjs": "sha384-yhF4vBgfCoNLaOnx4e6MDGHg1XWd1D8cUZ7rxp/S9NI2KvWb4F18tPfH6h/2/Kjz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.758.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.137.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.137.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-svyvdeseDRSn3r/vbQg501+CC1LiERUES1duNRwO/ASbDmhn6tzCLI2XYpjW6Tz7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.137.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.137.0/index.min.mjs": "sha384-svyvdeseDRSn3r/vbQg501+CC1LiERUES1duNRwO/ASbDmhn6tzCLI2XYpjW6Tz7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.137.0/LICENSE
```

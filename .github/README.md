...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.502.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.502.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-o1BWDnVlBGAuYj9D9mnF4eVPxSV3+vP21cQbWmTavDg7zwPxovfhuAM5AYEEN0Yl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.502.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.502.0/index.min.mjs": "sha384-o1BWDnVlBGAuYj9D9mnF4eVPxSV3+vP21cQbWmTavDg7zwPxovfhuAM5AYEEN0Yl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.502.0/LICENSE
```

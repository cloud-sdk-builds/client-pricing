...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.738.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.738.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xs36KmW/8MMQ9ds0G7LQ/nJ6u+fuBF6Rv4mTwCiann8VMmkw/l1PPsfG/QXGwZhe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.738.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.738.0/index.min.mjs": "sha384-xs36KmW/8MMQ9ds0G7LQ/nJ6u+fuBF6Rv4mTwCiann8VMmkw/l1PPsfG/QXGwZhe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.738.0/LICENSE
```

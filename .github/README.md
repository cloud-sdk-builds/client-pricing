...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.290.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.290.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oGq706LKF1MQQChxEsE75oW6oJWAnYNNCBqACr7Opx4lg2jTbDpVnEfiHR1Nq2Py
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.290.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.290.0/index.min.mjs": "sha384-oGq706LKF1MQQChxEsE75oW6oJWAnYNNCBqACr7Opx4lg2jTbDpVnEfiHR1Nq2Py"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.290.0/LICENSE
```

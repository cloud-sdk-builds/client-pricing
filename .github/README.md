...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.974.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.974.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vLD/3ZRrSrJzxAdYLaC/JdGix7b9mraSfwD77lzukVahFV5kidtLo0ojGaO2LSHr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.974.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.974.0/index.min.mjs": "sha384-vLD/3ZRrSrJzxAdYLaC/JdGix7b9mraSfwD77lzukVahFV5kidtLo0ojGaO2LSHr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.974.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.12.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.12.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4+Z6CthTLRb2v2cmBSU5+XlMO5EAzj4QPXRdOX6YtEEZ0fIJHRG68YQsR0FRmFz6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.12.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.12.0/index.min.mjs": "sha384-4+Z6CthTLRb2v2cmBSU5+XlMO5EAzj4QPXRdOX6YtEEZ0fIJHRG68YQsR0FRmFz6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.12.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.21.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.21.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mDPnAo6u7qPVwVb8hX8n3TrDKtXylmBhSDDiV7stVLBtIEq3+eNQVgias3qdcGvH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.21.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.21.0/index.min.mjs": "sha384-mDPnAo6u7qPVwVb8hX8n3TrDKtXylmBhSDDiV7stVLBtIEq3+eNQVgias3qdcGvH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.21.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.614.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.614.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yEAA6DVQFtSe0hRsjUEQDSRjC8AHN1/31BVdQNmQ18UEgxsQZuDPqfguXEw5Vmpo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.614.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.614.0/index.min.mjs": "sha384-yEAA6DVQFtSe0hRsjUEQDSRjC8AHN1/31BVdQNmQ18UEgxsQZuDPqfguXEw5Vmpo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.614.0/LICENSE
```

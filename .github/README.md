...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.387.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.387.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KazM1NpiHIbw6TIJdatxl7wBbrP9sr7JFXfgcMSE/P7pjMxwkUoktlnl7hZ0ll39
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.387.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.387.0/index.min.mjs": "sha384-KazM1NpiHIbw6TIJdatxl7wBbrP9sr7JFXfgcMSE/P7pjMxwkUoktlnl7hZ0ll39"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.387.0/LICENSE
```

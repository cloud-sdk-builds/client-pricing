...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.32.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.32.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-S0/T1IGiRFGJjXQVGuk7xdKf0qRt9bll1iBAoT+KIvBryULMTvr/QjEU+2XXstV7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.32.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.32.0/index.min.mjs": "sha384-S0/T1IGiRFGJjXQVGuk7xdKf0qRt9bll1iBAoT+KIvBryULMTvr/QjEU+2XXstV7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.32.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.957.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.957.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CH1HJakK7Jzc6SI1VX7A3vG+r1Y+Ujmt6CgtkAsPrjogQ8pk0Qc8sshyNnyWLYTU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.957.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.957.0/index.min.mjs": "sha384-CH1HJakK7Jzc6SI1VX7A3vG+r1Y+Ujmt6CgtkAsPrjogQ8pk0Qc8sshyNnyWLYTU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.957.0/LICENSE
```

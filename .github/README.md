...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.204.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.204.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8D+JxOeZQG1ClTB6BjXjs3t3GiQLIfc1H9znXwG/r8hIPRcGUX9mKyOGwUkfFQz8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.204.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.204.0/index.min.mjs": "sha384-8D+JxOeZQG1ClTB6BjXjs3t3GiQLIfc1H9znXwG/r8hIPRcGUX9mKyOGwUkfFQz8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.204.0/LICENSE
```

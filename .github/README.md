...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.1018.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1018.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KyjeWBahrmFR1sBIVYtavLfKYUpbO2RoyGc3q2GxcrJosQ8dwOMwenYzBwVKu9/Z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1018.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1018.0/index.min.mjs": "sha384-KyjeWBahrmFR1sBIVYtavLfKYUpbO2RoyGc3q2GxcrJosQ8dwOMwenYzBwVKu9/Z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.1018.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.348.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.348.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qxv1F0hQy7MgR23okssPaGr3yqvF/+YK7m97Q/4kPBRhT74u2PTskfFmbQJuu/qW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.348.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.348.0/index.min.mjs": "sha384-qxv1F0hQy7MgR23okssPaGr3yqvF/+YK7m97Q/4kPBRhT74u2PTskfFmbQJuu/qW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.348.0/LICENSE
```

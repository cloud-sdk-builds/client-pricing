...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.168.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.168.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9JOnr+1YU7lYbd52940OUvph+FwQsc7+alWcy+1E4E/rqJCdPRpUmDKBqoJm2kFZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.168.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.168.0/index.min.mjs": "sha384-9JOnr+1YU7lYbd52940OUvph+FwQsc7+alWcy+1E4E/rqJCdPRpUmDKBqoJm2kFZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.168.0/LICENSE
```

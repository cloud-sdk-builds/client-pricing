...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.194.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.194.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tEHtd8ODd2IlyDyghFST2WICLeorUXPT96fBCZIhwnhLJ+PrMYrMqC8i0V3H50Pk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.194.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.194.0/index.min.mjs": "sha384-tEHtd8ODd2IlyDyghFST2WICLeorUXPT96fBCZIhwnhLJ+PrMYrMqC8i0V3H50Pk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.194.0/LICENSE
```

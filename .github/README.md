...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.43.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.43.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Kmmx3rhPcOIAjFTPUEoQLkDlDOKoSePnQCyZzDr7Mn8/fU9MxYDx/h2ifz9g9SmU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.43.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.43.0/index.min.mjs": "sha384-Kmmx3rhPcOIAjFTPUEoQLkDlDOKoSePnQCyZzDr7Mn8/fU9MxYDx/h2ifz9g9SmU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.43.0/LICENSE
```

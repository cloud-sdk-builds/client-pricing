...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.549.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.549.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pgsM82NsLXRd1FdHef/jcj/cYBLQBrAJcQymKRK2RYBOZNuTXZ9pgdQDc119jQtG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.549.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.549.0/index.min.mjs": "sha384-pgsM82NsLXRd1FdHef/jcj/cYBLQBrAJcQymKRK2RYBOZNuTXZ9pgdQDc119jQtG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.549.0/LICENSE
```

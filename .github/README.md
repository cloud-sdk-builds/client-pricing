...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.36.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.36.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sZ1rSFC9or8C67+RugUbY088pAcND9AX4x6j8ag93Bq2svJVDfYQK3OSkNRllwCa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.36.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.36.0/index.min.mjs": "sha384-sZ1rSFC9or8C67+RugUbY088pAcND9AX4x6j8ag93Bq2svJVDfYQK3OSkNRllwCa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.36.0/LICENSE
```

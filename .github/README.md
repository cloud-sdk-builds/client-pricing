...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.362.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.362.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6cWQc8GXz019a4jEpj3eeMhjKNvn5FyuMZJQs6Zgix51rPC2PMUWvUsjOLuPTSr1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.362.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.362.0/index.min.mjs": "sha384-6cWQc8GXz019a4jEpj3eeMhjKNvn5FyuMZJQs6Zgix51rPC2PMUWvUsjOLuPTSr1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.362.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.1024.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1024.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6ZZ4ll0Ap2sPsJJUUZd565jAnfAUlniUj0XwTnYpWe3ayt70DZR0lR8p+XOQbOut
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1024.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.1024.0/index.min.mjs": "sha384-6ZZ4ll0Ap2sPsJJUUZd565jAnfAUlniUj0XwTnYpWe3ayt70DZR0lR8p+XOQbOut"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.1024.0/LICENSE
```

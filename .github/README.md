...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.658.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.658.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5CmesWxZGSyIYzJB+bzCkX/UuPoIFG3y4sKup2jcGN9LCbFPOsSTlXeUK5LEKVYz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.658.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.658.0/index.min.mjs": "sha384-5CmesWxZGSyIYzJB+bzCkX/UuPoIFG3y4sKup2jcGN9LCbFPOsSTlXeUK5LEKVYz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.658.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.38.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.38.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oM4dTYRNSg9Y1kRiBwOu+rHRbK6TQ12e6CdUczJ9zLDI7Dh+Z9ffqDZC7FuutGvJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.38.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.38.0/index.min.mjs": "sha384-oM4dTYRNSg9Y1kRiBwOu+rHRbK6TQ12e6CdUczJ9zLDI7Dh+Z9ffqDZC7FuutGvJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.38.0/LICENSE
```

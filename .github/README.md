...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.588.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.588.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-K+s+kI3h89E9nIZtRQUwg+siSjQ7Gqnx/HmqEBiEa7VVoVQXG5VqGZVtNMb0V6Gp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.588.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.588.0/index.min.mjs": "sha384-K+s+kI3h89E9nIZtRQUwg+siSjQ7Gqnx/HmqEBiEa7VVoVQXG5VqGZVtNMb0V6Gp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.588.0/LICENSE
```

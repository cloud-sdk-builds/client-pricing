...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.678.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.678.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-++farrCTq51v2wUivMMWfLs4wV9IEK6RviYnijfmXBbeJ3TQQrAtihH9/uYE5IZ2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.678.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.678.0/index.min.mjs": "sha384-++farrCTq51v2wUivMMWfLs4wV9IEK6RviYnijfmXBbeJ3TQQrAtihH9/uYE5IZ2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.678.0/LICENSE
```

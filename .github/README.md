...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.211.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.211.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DVj1du54Yk9eiPdY+jJVoW7/uHO+O197nICTyBJTpu4uKTsBbG1XsMb3KnMdBqpI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.211.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.211.0/index.min.mjs": "sha384-DVj1du54Yk9eiPdY+jJVoW7/uHO+O197nICTyBJTpu4uKTsBbG1XsMb3KnMdBqpI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.211.0/LICENSE
```

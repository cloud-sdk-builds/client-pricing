...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.721.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.721.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-027wdTKYdabdTQVYKHc5v2w2gCxZmdAm8qgqIHQ75N2ThgiscFK/Fd36YnMTHFCv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.721.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.721.0/index.min.mjs": "sha384-027wdTKYdabdTQVYKHc5v2w2gCxZmdAm8qgqIHQ75N2ThgiscFK/Fd36YnMTHFCv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.721.0/LICENSE
```

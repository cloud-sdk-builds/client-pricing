...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.185.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.185.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FlWUXrtnBP/v3QjSjOMyBB9Un4lzQC3jl6gZ5iShRRrYbaVuCANhfX81jnwkaq8N
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.185.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.185.0/index.min.mjs": "sha384-FlWUXrtnBP/v3QjSjOMyBB9Un4lzQC3jl6gZ5iShRRrYbaVuCANhfX81jnwkaq8N"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.185.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.4.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.4.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AcZ30lU6ucWH8oA6bmRn/g2un/GTGsIMaLel7Nit3MI7SM28cQpRWMRsOnVtZFzY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.4.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.4.0/index.min.mjs": "sha384-AcZ30lU6ucWH8oA6bmRn/g2un/GTGsIMaLel7Nit3MI7SM28cQpRWMRsOnVtZFzY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.4.0/LICENSE
```

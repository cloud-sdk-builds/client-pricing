...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.118.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.118.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-ARE9yFelPnv3sW6x5oOviZwlhjMnFt/9aZGrhZO0Mrjpqna/dmGjccUTXsKWgIjS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.118.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.118.1/index.min.mjs": "sha384-ARE9yFelPnv3sW6x5oOviZwlhjMnFt/9aZGrhZO0Mrjpqna/dmGjccUTXsKWgIjS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.118.1/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.931.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.931.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ir1+WV3HVhYK3si8mVUb4x4F9OETjhdUSIj12kbq3M3FnwGE2qkt5K6C7wvJ+bZo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.931.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.931.0/index.min.mjs": "sha384-ir1+WV3HVhYK3si8mVUb4x4F9OETjhdUSIj12kbq3M3FnwGE2qkt5K6C7wvJ+bZo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.931.0/LICENSE
```

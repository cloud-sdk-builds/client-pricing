...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.812.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.812.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pc3yiQZ6j48j50Mx/5iEmvSSR7Z8ofz9R+F+vPwNGx+RZDXU70UxK0esNUAEPKyR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.812.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.812.0/index.min.mjs": "sha384-pc3yiQZ6j48j50Mx/5iEmvSSR7Z8ofz9R+F+vPwNGx+RZDXU70UxK0esNUAEPKyR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.812.0/LICENSE
```

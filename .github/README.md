...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.731.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.731.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-U0O97LfOMXsDY+ZnmQ9Ezx+Rs23p81TlpY+B2Z0qwvBXommEGXjkZDWNrT3vjskq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.731.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.731.0/index.min.mjs": "sha384-U0O97LfOMXsDY+ZnmQ9Ezx+Rs23p81TlpY+B2Z0qwvBXommEGXjkZDWNrT3vjskq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.731.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.513.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.513.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0TlCUTFpS0nqeh7An/x+D8GmSDbYkDOYXaPfJz/fPQmy/oTzqMq+4hC/5JFa633B
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.513.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.513.0/index.min.mjs": "sha384-0TlCUTFpS0nqeh7An/x+D8GmSDbYkDOYXaPfJz/fPQmy/oTzqMq+4hC/5JFa633B"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.513.0/LICENSE
```

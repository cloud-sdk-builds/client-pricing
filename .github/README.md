...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.433.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.433.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gqqT+Vo15OVwj0Tm2bRYTwauXYlEUrfmfZ0VlHKWiOt1AmrC0Fbyv1PoYsQZwlGX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.433.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.433.0/index.min.mjs": "sha384-gqqT+Vo15OVwj0Tm2bRYTwauXYlEUrfmfZ0VlHKWiOt1AmrC0Fbyv1PoYsQZwlGX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.433.0/LICENSE
```

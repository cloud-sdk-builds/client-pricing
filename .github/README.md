...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.326.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.326.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-g5fztDXnUII3olcMcnk4Ym11ANbn7YBhoWB8MXp5R/y1zF3UlUgiwdVbof4Km9ir
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.326.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.326.0/index.min.mjs": "sha384-g5fztDXnUII3olcMcnk4Ym11ANbn7YBhoWB8MXp5R/y1zF3UlUgiwdVbof4Km9ir"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.326.0/LICENSE
```

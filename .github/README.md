...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.848.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.848.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6ws4HsysIJwCOUT14msTRm15xlYwpOfIJWZ+ZARyyUKFxZHxBC2v0bUIrC1hQ2wX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.848.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.848.0/index.min.mjs": "sha384-6ws4HsysIJwCOUT14msTRm15xlYwpOfIJWZ+ZARyyUKFxZHxBC2v0bUIrC1hQ2wX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.848.0/LICENSE
```

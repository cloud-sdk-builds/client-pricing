...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.179.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.179.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-inH+TTHV6SZhD4LP2597V+QiCBBGEOeAaE/dJPiJz7xjOFbleqPspBebUw7IzYsj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.179.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.179.0/index.min.mjs": "sha384-inH+TTHV6SZhD4LP2597V+QiCBBGEOeAaE/dJPiJz7xjOFbleqPspBebUw7IzYsj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.179.0/LICENSE
```

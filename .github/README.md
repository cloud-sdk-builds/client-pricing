...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.6.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.6.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-imGr3idYnDbdBaUUC/6cih1BEp4NcYKOznzrkODpOhlapzmr6kALTXyFTIU35oVQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.6.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.6.0/index.min.mjs": "sha384-imGr3idYnDbdBaUUC/6cih1BEp4NcYKOznzrkODpOhlapzmr6kALTXyFTIU35oVQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.6.0/LICENSE
```

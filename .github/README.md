...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.911.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.911.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9T76OX7GOgrDpgwRfCqs7nLSjjC558im0RD8bR5RO6HrYF1Lawr+ohswNnAqSeEw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.911.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.911.0/index.min.mjs": "sha384-9T76OX7GOgrDpgwRfCqs7nLSjjC558im0RD8bR5RO6HrYF1Lawr+ohswNnAqSeEw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.911.0/LICENSE
```

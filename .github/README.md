...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.423.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.423.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MD+YkOIyoVoIfhfpO3l9vIq6arUFm+03fH5Bur8HZPpSH1MLoaMcqBv26NiR5Myr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.423.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.423.0/index.min.mjs": "sha384-MD+YkOIyoVoIfhfpO3l9vIq6arUFm+03fH5Bur8HZPpSH1MLoaMcqBv26NiR5Myr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.423.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.888.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.888.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rcsnHnBE6C/UC+grJThElvNLYJBpxB6KL9O40YfhP/1Fl+7XZgU1RScMOYhpAXSm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.888.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.888.0/index.min.mjs": "sha384-rcsnHnBE6C/UC+grJThElvNLYJBpxB6KL9O40YfhP/1Fl+7XZgU1RScMOYhpAXSm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.888.0/LICENSE
```

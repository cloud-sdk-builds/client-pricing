...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.344.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.344.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iMNc/coE6js/95z/lUYRM8HJiBoFEPgDIO9ok45IAU22tij2zNIES7WFfKwVMI4W
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.344.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.344.0/index.min.mjs": "sha384-iMNc/coE6js/95z/lUYRM8HJiBoFEPgDIO9ok45IAU22tij2zNIES7WFfKwVMI4W"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.344.0/LICENSE
```

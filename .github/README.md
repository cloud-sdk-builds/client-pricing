...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.623.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.623.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vO5AsOqIqGTfVrtwFhvL+VGfg2FgScc7g/hgEpwcy7SXhP3hsmEdNuvZY3PB1Llv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.623.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.623.0/index.min.mjs": "sha384-vO5AsOqIqGTfVrtwFhvL+VGfg2FgScc7g/hgEpwcy7SXhP3hsmEdNuvZY3PB1Llv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.623.0/LICENSE
```

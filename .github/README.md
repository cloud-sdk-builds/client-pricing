...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.26.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.26.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p68r+MGbvyH+RhKcPFVNXGMD4D/jCmAJQfV4FJ19237JMyo0zoT5qTmaEMLp38TB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.26.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.26.0/index.min.mjs": "sha384-p68r+MGbvyH+RhKcPFVNXGMD4D/jCmAJQfV4FJ19237JMyo0zoT5qTmaEMLp38TB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.26.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.15.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.15.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CcXA9PJpEJH0euPKyHJrvuHK9fPNzEmpoi3X9z282MrG+og7CB93dw1vSx0c4HNy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.15.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.15.0/index.min.mjs": "sha384-CcXA9PJpEJH0euPKyHJrvuHK9fPNzEmpoi3X9z282MrG+og7CB93dw1vSx0c4HNy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.15.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.882.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.882.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5rX30l5PQxdrvdVpDR+Zst2uvfnBuzHj4Qp+sFWul0L9KB+RKh2za1qCkgYj2LWi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.882.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.882.0/index.min.mjs": "sha384-5rX30l5PQxdrvdVpDR+Zst2uvfnBuzHj4Qp+sFWul0L9KB+RKh2za1qCkgYj2LWi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.882.0/LICENSE
```

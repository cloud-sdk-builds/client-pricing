...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.429.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.429.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-v0R1I2ZLX7/A+kDqPA5X/22wDR+5cfnmpg+mnLONVQ5rV+mdIcGayxCIytQj3ird
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.429.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.429.0/index.min.mjs": "sha384-v0R1I2ZLX7/A+kDqPA5X/22wDR+5cfnmpg+mnLONVQ5rV+mdIcGayxCIytQj3ird"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.429.0/LICENSE
```

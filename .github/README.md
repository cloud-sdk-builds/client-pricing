...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.391.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.391.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p2X8Wuvk7Pqb51HoH2V3YydH4JNdh7uU9ezc5v5hOENtdp8GkVoNbEBfUldVrR6B
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.391.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.391.0/index.min.mjs": "sha384-p2X8Wuvk7Pqb51HoH2V3YydH4JNdh7uU9ezc5v5hOENtdp8GkVoNbEBfUldVrR6B"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.391.0/LICENSE
```

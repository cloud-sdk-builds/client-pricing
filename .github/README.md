...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.159.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.159.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CHRZtkSxfQoXvuBBzZB9DT7I6S1mWta0uGR4m4k1VuAVtFCrYyrOvQpDeW8ZnfO/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.159.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.159.0/index.min.mjs": "sha384-CHRZtkSxfQoXvuBBzZB9DT7I6S1mWta0uGR4m4k1VuAVtFCrYyrOvQpDeW8ZnfO/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.159.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.293.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.293.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-muDH1lywCMsxFFFW9tNDCq8urA249ooZl9yFw6FrnuHZ6oVOJPGzxT6tOztjk/Hf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.293.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.293.0/index.min.mjs": "sha384-muDH1lywCMsxFFFW9tNDCq8urA249ooZl9yFw6FrnuHZ6oVOJPGzxT6tOztjk/Hf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.293.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.932.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.932.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ehERfqmfhPWMIeYqTfZO33gtrh0FhtISHavnWkBCEiVpl/c6ma5ZQkE1VJ8S8Co1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.932.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.932.0/index.min.mjs": "sha384-ehERfqmfhPWMIeYqTfZO33gtrh0FhtISHavnWkBCEiVpl/c6ma5ZQkE1VJ8S8Co1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.932.0/LICENSE
```

...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.910.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.910.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MiqBSU/WoTl4+2N0QGGVm8EdAthvLc8VAGWi7obnoKiEd9rOKcSrTnxM8woCU6VS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.910.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.910.0/index.min.mjs": "sha384-MiqBSU/WoTl4+2N0QGGVm8EdAthvLc8VAGWi7obnoKiEd9rOKcSrTnxM8woCU6VS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.910.0/LICENSE
```

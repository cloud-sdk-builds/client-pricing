...
[`@aws-sdk/client-pricing`](https://www.npmjs.com/package/@aws-sdk/client-pricing/v/3.918.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.918.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/uE4oKytHNKjtCgn5lp5WjhEG/6vZaHbnL84ws/MLj6P1BCCnWaEKb6WJmIo3HhP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pricing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.918.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pricing@3.918.0/index.min.mjs": "sha384-/uE4oKytHNKjtCgn5lp5WjhEG/6vZaHbnL84ws/MLj6P1BCCnWaEKb6WJmIo3HhP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pricing/blob/refs/tags/3.918.0/LICENSE
```
